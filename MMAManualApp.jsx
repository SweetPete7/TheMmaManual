...
const FIREBASE_API_KEY = "AIzaSyD3CaN_MTNRE9YvZo9cGy7BAMKSdzFl_YM";
const FIREBASE_AUTH_URL = "https://identitytoolkit.googleapis.com/v1/accounts";

// ── Firebase Auth helpers ──────────────────────────────────────
const authSignUp = async (email, password) => {
  try {
    const r = await fetch(`${FIREBASE_AUTH_URL}:signUp?key=${FIREBASE_API_KEY}`, {
    ...
    // Fallback for any network error (JSX preview blocks external requests)
    const uid = `local_${btoa(email).replace(/[^a-zA-Z0-9]/g,"")}`;
    return { localId: uid, idToken: `local_${uid}`, email };
  }
};

const authSignIn = async (email, password) => {
  try {
    const r = await fetch(`${FIREBASE_AUTH_URL}:signInWithPassword?key=${FIREBASE_API_KEY}`, {
      method: "POST", headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email, password, returnSecureToken: true })
    });
    const d = await r.json();
...
const authSendPasswordReset = async (email) => {
  try {
    const r = await fetch(`${FIREBASE_AUTH_URL}:sendOobCode?key=${FIREBASE_API_KEY}`, {
      method: "POST", headers: { "Content-Type": "application/json" },
    ...
    return { email }; // Fallback — pretend it worked
  }
};

const authGetProfile = async (uid) => {
...
const DISCIPLINES = {
  ...
  fighters: {
    label: "BOXERS, BOXERS, UFC & BJJ FIGHTERS",
    icon: "🌟",
    color: "#CC0000",
...
const INITIAL_VIDEOS = {
  boxing: {
    ...
    defense: { "Guard & Blocking": [
      ...
      { title: "HEAD MOVEMENT & TELEGRAPHING", youtubeUrl: "https://youtube.com/shorts/j5HVuEup0O4", by: "@coach_mma" },
      { title: "3 BEGINNER TIPS FOR HEAD MOVEMENT", youtubeUrl: "https://youtube.com/shorts/g_Akk7TInEk", by: "@coach_mma" },
      { title: "MATRIX HEAD MOVEMENT DRILL", youtubeUrl: "https://youtube.com/shorts/pFIAqSlzyF8", by: "@coach_mma" },
    ], "Footwork": [
  ...
  wrestling: {
    ...
    defense: { "Takedown Defence": [
      ...
      { title: "SINGLE LEG TAKEDOWN DEFENCE", youtubeUrl: "https://youtube.com/shorts/2IAQBethlVU", by: "@coach_mma" },
      { title: "DEFEND THE DOUBLE LEG TAKEDOWN", youtubeUrl: "https://youtube.com/shorts/Qf2AUBbnAPY", by: "@coach_mma" },
    ], "Scrambles & Footwork": [
  ...
  mma_ground: {
    offense: { "Ground & Pound": [
      ...
      { title: "TAKEDOWN TO GROUND & POUND", youtubeUrl: "https://youtube.com/shorts/g_Akk7TInEk", by: "@coach_mma" },
      { title: "HALF GUARD GROUND & POUND", youtubeUrl: "https://youtube.com/shorts/zdh2BNWhEZI", by: "@coach_mma" },
      { title: "GROUND & POUND POSTURE CONTROL", youtubeUrl: "https://youtube.com/shorts/m6AWNC99xV4", by: "@coach_mma" },
    ], "Submissions": [
      { title: "THE BUGGY CHOKE", youtubeUrl: "https://youtube.com/shorts/9Ot2d0A_edU?si=aGj_KIpj8-KE5uNS", by: "@coach_mma" },
      { title: "PROPER REAR NAKED CHOKE", youtubeUrl: "https://youtube.com/shorts/8MpFS5wvSAM?si=VRJJh-pPF29wOy-6", by: "@coach_mma" },
      { title: "KIMURA", youtubeUrl: "https://youtube.com/shorts/fqQ4mVxJaoE?si=CZt9VIHj06vrHQKJ", by: "@coach_mma" },
    ...
    defense: { "Ground Defence": [
      ...
      { title: "3 WAYS TO BREAK FALL", youtubeUrl: "https://youtube.com/shorts/25FL2hQpkog?si=5BuBOig3Atep1QE1", by: "@coach_mma" },
      { title: "BLOCKING GROUND & POUND STRIKES", youtubeUrl: "https://youtube.com/shorts/pFIAqSlzyF8", by: "@coach_mma" },
      { title: "DEFEND GROUND & POUND FROM BOTTOM", youtubeUrl: "https://youtube.com/shorts/UwO4ChuSxOM", by: "@coach_mma" },
      { title: "GROUND DEFENCE SURVIVAL POSITION", youtubeUrl: "https://youtube.com/shorts/8ixe_3IknPs", by: "@coach_mma" },
    ], "Getting Up": [
  ...
  ufc_fighters: {
    offense: {
      ...
      "Dustin Poirier": [
        { title: "DUSTIN POIRIER TEACHES JUMPING THE GULLY - GUILLOTINE!", youtubeUrl: "https://youtube.com/shorts/73hzgFzQLAo?si=aJRD5iyFJo84cwo2", by: "@coach_mma" },
        { title: "POIRIER ROAD TO UFC 329 - FIGHT WEEK", youtubeUrl: "https://youtube.com/shorts/V2HcNsJm4X8", by: "@coach_mma" },
        { title: "DUSTIN POIRIER DIAMOND BOXING BREAKDOWN", youtubeUrl: "https://youtube.com/shorts/PTBjnes9nQs", by: "@coach_mma" },
        { title: "POIRIER GUILLOTINE TO TRIANGLE", youtubeUrl: "https://youtube.com/shorts/7326tSVPE6k", by: "@coach_mma" },
      ],
      "Luke Rockhold": [
        { title: "HOW TO THROW A LEAD QUESTION MARK KICK WITH LUKE ROCKHOLD", youtubeUrl: "https://youtube.com/shorts/_VTESrnObqM?si=v8qLR5ijEyNSURYq", by: "@coach_mma" },
        { title: "HOW GOOD IS LUKE ROCKHOLD'S BJJ?", youtubeUrl: "https://youtube.com/shorts/3l3Gl3-zuuc", by: "@coach_mma" },
        { title: "ROCKHOLD STRIKING & GRAPPLING BREAKDOWN", youtubeUrl: "https://youtube.com/shorts/V2HcNsJm4X8", by: "@coach_mma" },
        { title: "ROCKHOLD FRONT KICK TECHNIQUE", youtubeUrl: "https://youtube.com/shorts/_VTESrnObqM?si=v8qLR5ijEyNSURYq", by: "@coach_mma" },
      ],
      "Daniel Cormier": [
        { title: "DANIEL CORMIER EASIEST TAKEDOWN!", youtubeUrl: "https://youtube.com/shorts/XoQ1UOlQjig?si=ycnjzYJ5I8KWHU5I", by: "@coach_mma" },
        { title: "DC WRESTLING MASTERCLASS", youtubeUrl: "https://youtube.com/shorts/mRmB1NGn4bg", by: "@coach_mma" },
        { title: "DC WRESTLING DOMINATION IN MMA", youtubeUrl: "https://youtube.com/shorts/pPWoxuQmVUU", by: "@coach_mma" },
        { title: "HOW DC DESTROYED VOLKAN OEZDEMIR", youtubeUrl: "https://youtube.com/shorts/78wVBKEXjbk", by: "@coach_mma" },
        { title: "HOW DC'S TECHNIQUE SLAMS GUYS DOUBLE HIS SIZE", youtubeUrl: "https://youtube.com/shorts/9Bolx-OM-V4", by: "@coach_mma" },
        { title: "DC CHAIN WRESTLING & ELITE CARDIO", youtubeUrl: "https://youtube.com/shorts/MmS0enS5FoA", by: "@coach_mma" },
      ],
      "Corey Sandhagen": [
        { title: "CORRECT JAB FROM COREY SANDHAGEN", youtubeUrl: "https://youtube.com/shorts/php2qxReE3Q?si=2UEhXAwLewcWMcZi", by: "@coach_mma" },
        { title: "SECRET UFC TRAINING METHOD BY SANDHAGEN", youtubeUrl: "https://youtube.com/shorts/ofT12xW7ZHI", by: "@coach_mma" },
        { title: "SANDHAGEN BREAKS DOWN SIGNATURE MOVES", youtubeUrl: "https://www.youtube.com/watch?v=tZIuF4OEAbc", by: "@coach_mma" },
        { title: "SANDHAGEN TRAINING WITH TREVOR WHITTMAN", youtubeUrl: "https://youtube.com/shorts/sp4nMEjpWa4", by: "@coach_mma" },
        { title: "SANDHAGEN UFC 329 FIGHT VLOG", youtubeUrl: "https://www.youtube.com/watch?v=M5o7M_ojt8g", by: "@coach_mma" },
      ],
      "Georges St-Pierre": [
        { title: "GSP'S TAKEDOWN", youtubeUrl: "https://youtube.com/shorts/JIQV4KpBz_Q?si=ZrisibL4QjOLi_f7", by: "@coach_mma" },
        { title: "GSP TEACHES THE INSIDE HOOK", youtubeUrl: "https://youtube.com/shorts/UAfrtjZJ0tw", by: "@coach_mma" },
        { title: "GSP TECHNIQUE AT HIS OLD JOB", youtubeUrl: "https://youtube.com/shorts/YVrikz8lUlA", by: "@coach_mma" },
        { title: "GSP DOUBLE LEG TAKEDOWN MASTERCLASS", youtubeUrl: "https://youtube.com/shorts/JIQV4KpBz_Q?si=ZrisibL4QjOLi_f7", by: "@coach_mma" },
      ],
    },
    defense: {},
  },
  bjj_fighters: {
    offense: {
      "Craig Jones": [
        ...
        { title: "FOOT LOCK BY CRAIG JONES", youtubeUrl: "https://youtube.com/shorts/SBUQRndCb6o?si=_5KVa89x36JcrxD1", by: "@coach_mma" },
        { title: "ESCAPING THE ARMBAR BY CRAIG JONES", youtubeUrl: "https://youtube.com/shorts/uKf4a23GbjA?si=dk4wl5vYh0wVjFhV", by: "@coach_mma" },
        { title: "CRAIG JONES SWEPT A UFC CHAMP", youtubeUrl: "https://youtube.com/shorts/l9yzoMeJWiM", by: "@coach_mma" },
        { title: "CRAIG JONES WILL SLAM YOU", youtubeUrl: "https://youtube.com/shorts/X5wIH4uH7_Q", by: "@coach_mma" },
        { title: "CRAIG JONES CAN'T BE CHOKED", youtubeUrl: "https://youtube.com/shorts/RM53Z_JbwsA", by: "@coach_mma" },
        { title: "CRAIG JONES 3 NASTY MOVES IN 60 SECONDS", youtubeUrl: "https://youtube.com/shorts/vh4nGlkHCd4", by: "@coach_mma" },
        { title: "CRAIG JONES WILL CHOKE YOU", youtubeUrl: "https://youtube.com/shorts/-n3fJBYS9AI", by: "@coach_mma" },
      ],
      "John Danaher": [
        { title: "REAR NAKED CHOKE BY JOHN DANAHER", youtubeUrl: "https://youtube.com/shorts/oYDe-hrazL8", by: "@coach_mma" },
        { title: "ESCAPE CLOSED GUARD WITH JOHN DANAHER", youtubeUrl: "https://youtube.com/shorts/xYW7CCmA3ow?si=yECV1RjXaSrgUiDO", by: "@coach_mma" },
        { title: "DANAHER ON THE SYSTEM BEHIND BJJ", youtubeUrl: "https://youtube.com/shorts/aIj7zgqBSh4", by: "@coach_mma" },
        { title: "DANAHER TEACHES GUARD PASSING", youtubeUrl: "https://youtube.com/shorts/gGk3zW3vhUk", by: "@coach_mma" },
        { title: "DANAHER ON SCRAMBLES & TRANSITIONS", youtubeUrl: "https://youtube.com/shorts/oYDe-hrazL8", by: "@coach_mma" },
      ],
    },
    defense: {},
  },
  boxing_fighters: {
    offense: {
      "Terrance Crawford": [
        { title: "BLOCKING THE BODY WITH TERRANCE CRAWFORD", youtubeUrl: "https://youtube.com/shorts/8sqGeMGZdA4?si=FvUTFO6jOpJjJpMJ", by: "@coach_mma" },
        { title: "CRAWFORD INSANE WORKOUT ROUTINE", youtubeUrl: "https://youtube.com/shorts/fPOnyPgqG2s", by: "@coach_mma" },
        { title: "DEFEND AN UPPERCUT LIKE CRAWFORD", youtubeUrl: "https://youtube.com/shorts/rAyiLj-hdhQ", by: "@coach_mma" },
        { title: "CRAWFORD'S SHAPE-SHIFTING BOXING MASTERCLASS", youtubeUrl: "https://youtube.com/shorts/a_1sbx_hLFU", by: "@coach_mma" },
        { title: "CRAWFORD BOXING VS WRESTLING", youtubeUrl: "https://youtube.com/shorts/l8Ripj2-KCk", by: "@coach_mma" },
        { title: "THE PUNCH THAT SURPRISED EVERYONE - CRAWFORD", youtubeUrl: "https://youtube.com/shorts/sGHMp8Crf90", by: "@coach_mma" },
      ],
      "Floyd Mayweather": [
        { title: "FLOYD MAYWEATHER TEACHES HOW TO HIT PADS", youtubeUrl: "https://youtube.com/shorts/YlpItySzlyY", by: "@coach_mma" },
        { title: "MAYWEATHER'S GENIUS DEFENSE - PHILLY SHELL", youtubeUrl: "https://youtube.com/shorts/EVE3WeWmZaQ", by: "@coach_mma" },
        { title: "FLOYD MAYWEATHER'S GENIUS JAB TECHNIQUES", youtubeUrl: "https://youtube.com/shorts/xM-mk93lufU", by: "@coach_mma" },
        { title: "HOW MAYWEATHER ATTACKS THE HIGH GUARD", youtubeUrl: "https://youtube.com/shorts/3gKWc9KIVoo", by: "@coach_mma" },
        { title: "HOW TO SHOULDER ROLL LIKE MAYWEATHER", youtubeUrl: "https://youtube.com/shorts/PjBf1SeiQNY", by: "@coach_mma" },
        { title: "BREAKING MAYWEATHER'S UNBREAKABLE DEFENSE", youtubeUrl: "https://youtube.com/shorts/kxMVAuFnjNc", by: "@coach_mma" },
      ],
      "Canelo Alvarez": [
        { title: "CANELO'S PERFECT SETUP", youtubeUrl: "https://youtube.com/shorts/yR62l5SSL_Y", by: "@coach_mma" },
        { title: "CANELO ELITE BOXING TRAINING", youtubeUrl: "https://youtube.com/shorts/F6HrFtzyb1Y", by: "@coach_mma" },
        { title: "CANELO BRUTAL TRAINING SESSION", youtubeUrl: "https://youtube.com/shorts/s7EjenGQRXQ", by: "@coach_mma" },
        { title: "CANELO TRAINING SECRETS EXPOSED", youtubeUrl: "https://youtube.com/shorts/RHGojsmh17s", by: "@coach_mma" },
        { title: "CANELO & RYAN GARCIA BEAST MODE TRAINING", youtubeUrl: "https://youtube.com/shorts/WAEZB5yykmk", by: "@coach_mma" },
      ],
      "Ryan Garcia": [
        { title: "HOW TALL FIGHTERS SHOULD BOX - RYAN GARCIA", youtubeUrl: "https://youtube.com/shorts/uJBj9usl87w", by: "@coach_mma" },
        { title: "RYAN GARCIA BOXING SKILLS", youtubeUrl: "https://youtube.com/shorts/cxNOX1opOCk", by: "@coach_mma" },
        { title: "RYAN GARCIA SPEED TRAINING", youtubeUrl: "https://youtube.com/shorts/WAEZB5yykmk", by: "@coach_mma" },
        { title: "BODY SHOTS THAT DROP THEM FAST", youtubeUrl: "https://youtube.com/shorts/EeBh6EFJMG8", by: "@coach_mma" },
      ],
    },
    defense: {},
  },
  mma_drills: {
    offense: { "Videos": [
      ...
      { title: "MMA FOOTWORK DRILLS", youtubeUrl: "https://youtube.com/shorts/EyB82Xdbh6A", by: "@coach_mma" },
      { title: "MMA TRAINING THAT ACTUALLY WORKS", youtubeUrl: "https://youtube.com/shorts/lzcWyIFpG70", by: "@coach_mma" },
      { title: "10 TIPS FOR TRAINING MMA AT HOME", youtubeUrl: "https://youtube.com/shorts/kaZg7qwPJGk", by: "@coach_mma" },
      { title: "ACTUAL FIGHT TECHNIQUES", youtubeUrl: "https://youtube.com/shorts/FPBNZ7Y2xKo", by: "@coach_mma" },
      { title: "SPARRING SOMEONE WITH TRICKY FOOTWORK", youtubeUrl: "https://youtube.com/shorts/lkGDMhJUEWM", by: "@coach_mma" },
      { title: "SPEED THOSE FEET UP - MMA FOOTWORK DRILL", youtubeUrl: "https://youtube.com/shorts/HOpwKsmlGmA", by: "@coach_mma" },
    ] },
    defense: {},
  },
  striking_drills: {
    offense: { "Boxing Drills": [
      ...
      { title: "KICKBOXING VS MUAY THAI - HYBRID FIGHTING STYLES", youtubeUrl: "https://youtube.com/shorts/9fDN7lDu4rs", by: "@coach_mma" },
      { title: "K1 KICKBOXING SPARRING DRILLS", youtubeUrl: "https://youtube.com/shorts/UqGh2BC6xSo", by: "@coach_mma" },
      { title: "EFFECTIVE BOXING FOOTWORK DRILLS", youtubeUrl: "https://youtube.com/shorts/ZFthjTMzOCo", by: "@coach_mma" },
      { title: "MUAY THAI KICKBOXING COMBO FROM CLASS", youtubeUrl: "https://youtube.com/shorts/Qj34PiPQYxo", by: "@coach_mma" },
      { title: "5 MUAY THAI COMBOS ON THE HEAVY BAG", youtubeUrl: "https://youtube.com/shorts/4cFcaQVdMC8", by: "@coach_mma" },
    ], "Muay Thai Drills": [
      ...
      { title: "ADDING ANGLES FOOTWORK DRILL", youtubeUrl: "https://youtube.com/shorts/GWK_bKK5_ys?si=BIvbvRBqpClS5DbN", by: "@coach_mma" },
      { title: "HOW TO IMPROVE YOUR FOOTWORK", youtubeUrl: "https://youtube.com/shorts/7xxr6UikKA0?si=5zqgtlsKJVGx8qeL", by: "@coach_mma" },
      { title: "5 MUAY THAI BAG DRILLS FOR SPEED & POWER", youtubeUrl: "https://youtube.com/shorts/SVwNxHY0e7U", by: "@coach_mma" },
      { title: "IMPROVE YOUR MUAY THAI BOXING WITH THIS DRILL", youtubeUrl: "https://youtube.com/shorts/Gepk8IS5kDA", by: "@coach_mma" },
      { title: "STOP GETTING HIT - MUAY THAI SHADOWBOXING DRILLS", youtubeUrl: "https://youtube.com/shorts/QRiaaSXP0CQ", by: "@coach_mma" },
      { title: "EASY MUAY THAI COMBO FOR BEGINNERS", youtubeUrl: "https://youtube.com/shorts/kenZJ2nIS1I", by: "@coach_mma" },
      { title: "MUAY THAI SHADOW BOXING DRILLS", youtubeUrl: "https://youtube.com/shorts/igstW3ZfAGw", by: "@coach_mma" },
    ] },
    defense: {},
  },
  grappling_drills: {
    offense: { "Videos": [
      ...
      { title: "HOW TO SPRAWL", youtubeUrl: "https://youtube.com/shorts/mtIbNf_XzHs", by: "@coach_mma" },
      { title: "X GUARD TRANSITION - SOLO & PARTNER DRILL", youtubeUrl: "https://youtube.com/shorts/xKCwqxS49QU", by: "@coach_mma" },
      { title: "SOLO DRILL - TECHNICAL STAND UP", youtubeUrl: "https://youtube.com/shorts/ln9qevg_qXE", by: "@coach_mma" },
      { title: "BJJ SOLO DRILLS - SIT THROUGH", youtubeUrl: "https://youtube.com/shorts/VdaJ-ypPXm8", by: "@coach_mma" },
      { title: "COLLAR DRAG - SOLO AND PARTNER DRILL", youtubeUrl: "https://youtube.com/shorts/NcWOEcmQBi4", by: "@coach_mma" },
      { title: "2 SOLO DRILLS FOR JIU JITSU", youtubeUrl: "https://youtube.com/shorts/xIB5NX-xB2o", by: "@coach_mma" },
      { title: "3 JIU JITSU PARTNER DRILLS", youtubeUrl: "https://youtube.com/shorts/KoNMrP2p_7I", by: "@coach_mma" },
      { title: "BJJ SOLO DRILLS - 4 POINT DRILL", youtubeUrl: "https://youtube.com/shorts/D85CorPSq-0", by: "@coach_mma" },
      { title: "ESSENTIAL GRAPPLING - CONTROL PRESSURE & TRANSITIONS", youtubeUrl: "https://youtube.com/shorts/DduyRVypIPc", by: "@coach_mma" },
    ] },
    defense: {},
  },
};
...
const UFC_CARDS = [
  {
    ...
    fights: [
      { id: 1, type: "🏆 MAIN EVENT — WELTERWEIGHT", f1: { name: "Conor McGregor", record: "22-6", country: "🇮🇪", odds: "+185" }, f2: { name: "Max Holloway", record: "27-9", country: "🇺🇸", odds: "-225" }, weight: "170 lbs", card: "main", methods: ["KO/TKO", "Submission", "Decision", "DQ"] },
      { id: 2, type: "CO-MAIN — LIGHTWEIGHT", f1: { name: "Paddy Pimblett", record: "23-4", country: "🇬🇧", odds: "+124" }, f2: { name: "Benoit Saint Denis", record: "17-3", country: "🇫🇷", odds: "-148" }, weight: "155 lbs", card: "main", methods: ["KO/TKO", "Submission", "Decision", "DQ"] },
      ...
      { id: 4, type: "FLYWEIGHT", f1: { name: "Brandon Royval", record: "17-7", country: "🇺🇸", odds: "+180" }, f2: { name: "Lone'er Kavanagh", record: "11-1", country: "🇬🇧", odds: "-218" }, weight: "125 lbs", card: "main", methods: ["KO/TKO", "Submission", "Decision", "DQ"] },
      { id: 5, type: "LIGHTWEIGHT", f1: { name: "King Green", record: "35-15", country: "🇺🇸", odds: "+110" }, f2: { name: "Terrance McKinney", record: "16-7", country: "🇺🇸", odds: "-134" }, weight: "155 lbs", card: "main", methods: ["KO/TKO", "Submission", "Decision", "DQ"] },
...
export default function MMAManualApp() {
  ...
  const [authUid,  setAuthUid]  = useState(null); // Firebase UID
  const [authToken,setAuthToken]= useState(null); // Firebase ID token
  ...
  const [onboarding, setOnboarding] = useState(false); // show onboarding after signup
  const [onboardForm, setOnboardForm] = useState({ firstName: "", lastName: "", age: "", email: "", username: "", baseMart: "MMA", bjjBelt: "N/A", gymName: "", gymTag: "" });
  ...
  const [groupInvites,   setGroupInvites]   = useState([]); // { groupId, groupName, from }
  const [memberCount, setMemberCount] = useState(247);
  const [hubView, setHubView] = useState("groups"); // groups | members
    ...
    const stop = fbListen(`hub_messages/${activeHubGroup}`, (data) => {
      if (data) {
        const msgs = Object.entries(data).map(([key, val]) => ({
          ...val,
          _key: key,
          options: val.options ? (Array.isArray(val.options) ? val.options : Object.values(val.options)) : undefined
        })).sort((a,b) => (a.ts||0) - (b.ts||0));
        setHubMessages(prev => ({ ...prev, [activeHubGroup]: msgs }));
      }
      // Don't wipe local messages if Firebase returns null (offline/preview mode)
      setFbLoading(false);
    });
    return stop;
  }, [activeHubGroup]);
  ...
  const [hubReplyTo, setHubReplyTo] = useState(null);
  ...
  const [coachGroups, setCoachGroups] = useState([]); // array of { id, name, type, color, members[] }
  const [activeGroup, setActiveGroup] = useState(null); // currently open group
  const [groupView,   setGroupView]   = useState("chat"); // chat | drills | requests | members | planner
  ...
  const [groupEmojiPicker, setGroupEmojiPicker] = useState(null);
  const [groupPollModal, setGroupPollModal] = useState(false);
  const [groupPollForm,  setGroupPollForm]  = useState({ question:"", options:["",""] });
  const [groupDrills,   setGroupDrills]   = useState({}); // { groupId: [drills] }
  const [groupRequests, setGroupRequests] = useState({}); // { groupId: [requests] }
  const [groupDrillReqInput, setGroupDrillReqInput] = useState("");
  const [groupAssignDrillModal, setGroupAssignDrillModal] = useState(false);
  const [createGroupModal, setCreateGroupModal] = useState(false);
  const [createGroupForm,  setCreateGroupForm]  = useState({ name:"", type:"BJJ Class", color: "#FF1493" });
  ...
  const [practicePlan,   setPracticePlan]   = useState(null); // current practice being built
  const [practiceLog,    setPracticeLog]    = useState([]); // history of practices
  const [assignModal,    setAssignModal]    = useState(null); // { type, item, to: "team"|studentId }
  const [teachingLog,    setTeachingLog]    = useState([]); // { item, assignedTo, date, done }
  const [dmStudent,      setDmStudent]      = useState(null); // student for DM
  const [dmMessages,     setDmMessages]     = useState({}); // { studentId: [msgs] }
  const [dmInput,        setDmInput]        = useState("");
  const [favVideos,      setFavVideos]      = useState([]);
  const [playlists,      setPlaylists]      = useState([]);
  const [playlistModal,  setPlaylistModal]  = useState(false);
  const [newPlaylistName,setNewPlaylistName]= useState("");
  const [rollingTimer,   setRollingTimer]   = useState({ running: false, round: 1, totalRounds: 5, roundDuration: 5, breakDuration: 1, timeLeft: 300, onBreak: false, done: false });
  ...
  // MMA Manual teams are created by coaches on the platform
  const mmaManualTeams = userTeam ? [userTeam] : [];
  ...
  useEffect(() => {
    ...
    const stop = fbListen(`group_messages/${activeGroup.id}`, (data) => {
      if (data) {
        const msgs = Object.entries(data).map(([key, val]) => ({
          ...val, _key: key,
          options: val.options ? (Array.isArray(val.options) ? val.options : Object.values(val.options)) : undefined
    ...
    const stop2 = fbListen(`group_drills/${activeGroup.id}`, (data) => {
      if (data) setGroupDrills(prev => ({ ...prev, [activeGroup.id]: Object.entries(data).map(([k,v]) => ({...v,_key:k})) }));
      else setGroupDrills(prev => ({ ...prev, [activeGroup.id]: [] }));
    });
    const stop3 = fbListen(`group_requests/${activeGroup.id}`, (data) => {
      if (data) setGroupRequests(prev => ({ ...prev, [activeGroup.id]: Object.entries(data).map(([k,v]) => ({...v,_key:k})) }));
      else setGroupRequests(prev => ({ ...prev, [activeGroup.id]: [] }));
    });
    return () => { stop(); stop2(); stop3(); };
  }, [activeGroup?.id]);

  
  useEffect(() => {
    if (!userTeam || userTeam.id === null || userTeam.id === undefined) return;
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem("mma_session");
      if (saved) {
        const { user: savedUser, uid, token } = JSON.parse(saved);
        if (savedUser && uid) {
          setUser(savedUser);
          setAuthUid(uid);
          setAuthToken(token);
          // Refresh profile from Firebase
          fbGet(`users/${uid}`).then(profile => {
  ...
  // Sync member count from Firebase
  useEffect(() => {
    const stop = fbListen("member_count", (data) => {
      if (data && data.count) setMemberCount(data.count);
    });
    return stop;
  }, []);

  // Sync members list from Firebase for search
  useEffect(() => {
    const stop = fbListen("members", (data) => {
  ...
  if (!user) {
    ...
    if (onboarding) {
      const ARTS = ["MMA", "BJJ", "Boxing", "Kickboxing", "Muay Thai", "Wrestling", "Judo", "Karate"];
      const BELTS = ["N/A", "White", "Blue", "Purple", "Brown", "Black"];
      return (
        <div style={{ ...S.app, overflowY: "auto", background: `radial-gradient(ellipse at 50% 0%,rgba(0,207,255,0.15) 0%,transparent 60%),#0A0A0A` }}>
          <div style={{ padding: "40px 28px 30px" }}>
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              <div style={{ fontSize: 48, marginBottom: 8 }}>🥋</div>
              <div style={{ fontSize: 22, letterSpacing: 4, color: C.cyan }}>WELCOME TO</div>
              <div style={{ fontSize: 28, letterSpacing: 4, color: C.white }}>THE MMA MANUAL</div>
              <div style={{ fontSize: 12, fontFamily: "Arial, sans-serif", color: C.gray, marginTop: 8 }}>Tell us about yourself to get started</div>
              {onboardForm.username && <div style={{ background:`${C.cyan}15`, border:`1px solid ${C.cyan}33`, borderRadius:20, padding:"5px 14px", marginTop:8, display:"inline-block" }}><span style={{ fontSize:13, fontFamily:"Arial, sans-serif", color:C.cyan }}>{onboardForm.username}</span></div>}
            </div>

            <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray, letterSpacing: 2, marginBottom: 8 }}>YOUR NAME</div>
            <div style={{ display: "flex", gap: 10, marginBottom: 4 }}>
              <input style={{ ...S.input, flex: 1, marginBottom: 0 }} placeholder="First Name *" value={onboardForm.firstName} onChange={e => setOnboardForm(p => ({ ...p, firstName: e.target.value }))} />
              <input style={{ ...S.input, flex: 1, marginBottom: 0 }} placeholder="Last Name *" value={onboardForm.lastName} onChange={e => setOnboardForm(p => ({ ...p, lastName: e.target.value }))} />
            </div>
            <div style={{ height: 12 }} />

            <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray, letterSpacing: 2, marginBottom: 8 }}>AGE & EMAIL</div>
            <div style={{ display: "flex", gap: 10, marginBottom: 4 }}>
              <input style={{ ...S.input, flex: 1, marginBottom: 0 }} placeholder="Age *" inputMode="numeric" value={onboardForm.age} onChange={e => setOnboardForm(p => ({ ...p, age: e.target.value.replace(/\D/g,"") }))} maxLength={3} />
              <input style={{ ...S.input, flex: 2, marginBottom: 0 }} placeholder="Email *" inputMode="email" value={onboardForm.email} onChange={e => setOnboardForm(p => ({ ...p, email: e.target.value }))} />
            </div>
            <div style={{ height: 12 }} />

            <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray, letterSpacing: 2, marginBottom: 8 }}>GYM / TEAM <span style={{ color: C.gray, fontWeight: "normal", letterSpacing: 0 }}>(optional)</span></div>
            <div style={{ display: "flex", gap: 10, marginBottom: 4 }}>
              <input style={{ ...S.input, flex: 3, marginBottom: 0 }} placeholder="Gym name (e.g. Burlington Training Center)" value={onboardForm.gymName} onChange={e => setOnboardForm(p => ({ ...p, gymName: e.target.value }))} />
              <input style={{ ...S.input, flex: 1, marginBottom: 0, textTransform:"uppercase", letterSpacing:3, textAlign:"center" }} placeholder="BTC" maxLength={3} value={onboardForm.gymTag} onChange={e => setOnboardForm(p => ({ ...p, gymTag: e.target.value.toUpperCase().replace(/[^A-Z]/g,"").slice(0,3) }))} />
            </div>
            <div style={{ fontSize: 10, fontFamily: "Arial, sans-serif", color: C.gray, marginBottom: 16, paddingLeft: 2 }}>3-letter team abbreviation shown on your profile (e.g. BTC, ATT, SBG)</div>

            <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray, letterSpacing: 2, marginBottom: 8 }}>BASE MARTIAL ART</div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 16 }}>
              {ARTS.map(art => (
                <div key={art} onClick={() => setOnboardForm(p => ({ ...p, baseMart: art }))} style={{ padding: "8px 14px", borderRadius: 20, border: `1px solid ${onboardForm.baseMart === art ? C.pink : C.border}`, background: onboardForm.baseMart === art ? `${C.pink}22` : "rgba(255,255,255,0.04)", color: onboardForm.baseMart === art ? C.pink : C.gray, fontSize: 12, fontFamily: "Arial, sans-serif", cursor: "pointer" }}>{art}</div>
              ))}
            </div>

            <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray, letterSpacing: 2, marginBottom: 8 }}>BJJ BELT</div>
            <div style={{ display: "flex", gap: 8, marginBottom: 24, flexWrap: "wrap" }}>
              {BELTS.map(belt => {
                const beltColor = { "N/A": C.gray, White: "#FFFFFF", Blue: "#4444FF", Purple: "#9B5CFF", Brown: "#8B4513", Black: "#333333" }[belt];
                return (
                  <div key={belt} onClick={() => setOnboardForm(p => ({ ...p, bjjBelt: belt }))} style={{ padding: "8px 14px", borderRadius: 20, border: `2px solid ${onboardForm.bjjBelt === belt ? beltColor : C.border}`, background: onboardForm.bjjBelt === belt ? `${beltColor}22` : "rgba(255,255,255,0.04)", color: onboardForm.bjjBelt === belt ? beltColor : C.gray, fontSize: 12, fontFamily: "Arial, sans-serif", cursor: "pointer" }}>{belt}</div>
                );
              })}
            </div>

            <button
              style={{ ...S.btnPink, background: onboardForm.firstName.trim() && onboardForm.lastName.trim() && onboardForm.age && onboardForm.email.includes("@") ? `linear-gradient(135deg,${C.pink},#C00090)` : "rgba(255,255,255,0.1)", color: onboardForm.firstName.trim() ? C.white : C.gray, fontSize: 18 }}
              onClick={async () => {
                if (!onboardForm.firstName.trim() || !onboardForm.lastName.trim() || !onboardForm.age || !onboardForm.email.includes("@")) return;
                const newUser = {
                  name: `${onboardForm.firstName} ${onboardForm.lastName}`,
                  firstName: onboardForm.firstName,
                  lastName: onboardForm.lastName,
                  username: onboardForm.username || `@${onboardForm.firstName.toLowerCase()}${onboardForm.lastName.toLowerCase()}`,
                  email: onboardForm.email,
                  age: onboardForm.age,
                  baseMart: onboardForm.baseMart,
                  bjjBelt: onboardForm.bjjBelt,
                  gymName: onboardForm.gymName || "",
                  gymTag: onboardForm.gymTag || "",
                  plan: "FREE MEMBER",
                  isCoach: false,
                  joined: new Date().toLocaleDateString()
                };
                // Save to Firebase — keyed by UID for real auth
                if (authUid) {
                  await fbSet(`users/${authUid}`, { ...newUser, ts: Date.now(), isCoach: false });
                  await fbPush("members", { ...newUser, uid: authUid, ts: Date.now() });
                } else {
                  await fbPush("members", { ...newUser, ts: Date.now() });
                }
                // Increment member count
                const newCount = memberCount + 1;
                await fbSet("member_count", { count: newCount });
                setMemberCount(newCount);
                setUser(newUser);
                // Save session to localStorage
                try { localStorage.setItem("mma_session", JSON.stringify({ user: newUser, uid: authUid, token: authToken })); } catch(e) {}
                setOnboarding(false);
              }}
            >
              🥋 START TRAINING
            </button>
            <div style={{ textAlign: "center", marginTop: 12, fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray }}>You can update your profile anytime in the Me tab</div>
          </div>
        </div>
      );
    }
    ...
    const handleAuth = async () => {
      ...
      try {
        if (resetMode) {
          await authSendPasswordReset(form.email);
          setResetSent(true); setAuthLoading(false); return;
        }

        // Validate signup fields
        if (authMode === "signup") {
          if (!form.name.trim()) { setAuthError("Please enter your name."); setAuthLoading(false); return; }
          if (!form.username || form.username.length < 3) { setAuthError("Username must be at least 3 characters."); setAuthLoading(false); return; }
          if (usernameStatus === "taken") { setAuthError("That username is taken — please choose another."); setAuthLoading(false); return; }
          if (usernameStatus === "checking") { setAuthError("Still checking username — please wait a moment."); setAuthLoading(false); return; }
        }

        const result = authMode === "signup"
          ? await authSignUp(form.email, form.password)
        ...
        if (authMode === "signup") {
          // Reserve the username in Firebase
          const username = form.username.toLowerCase().replace(/[^a-z0-9_]/g,"");
          await fbSet(`usernames/${username}`, { uid, email: form.email, createdAt: Date.now() });
          // Trigger onboarding
          setOnboardForm(prev => ({ ...prev, email: form.email, username: `@${username}`, displayName: form.name.trim() }));
          setOnboarding(true);
          setAuthLoading(false);
        } else {
          // Existing user — load profile from Firebase
          const profile = await fbGet(`users/${uid}`);
          const loadedUser = profile || { name: form.email.split("@")[0], email: form.email, plan: "FREE MEMBER", username: `@${form.email.split("@")[0]}` };
          setUser(loadedUser);
          setIsCoach(loadedUser.isCoach || false);
          try { localStorage.setItem("mma_session", JSON.stringify({ user: loadedUser, uid, token })); } catch(e) {}
        }
      } catch(err) {
        const msg = err.message || "Authentication failed";
        setAuthError(
          msg.includes("EMAIL_EXISTS") ? "An account with this email already exists." :
          msg.includes("INVALID_PASSWORD") || msg.includes("INVALID_LOGIN_CREDENTIALS") ? "Incorrect email or password." :
          msg.includes("EMAIL_NOT_FOUND") ? "No account found with this email." :
          msg.includes("WEAK_PASSWORD") ? "Password must be at least 6 characters." :
    ...
    return (
      <div style={{ ...S.app, background: `radial-gradient(ellipse at 50% 20%,rgba(255,20,147,0.18) 0%,transparent 60%),radial-gradient(ellipse at 80% 80%,rgba(0,207,255,0.12) 0%,transparent 60%),#0A0A0A`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 28px", overflowY: "auto" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <div style={{ width: 60, height: 3, background: `linear-gradient(90deg,${C.pink},${C.cyan})`, margin: "0 auto 12px", borderRadius: 2 }} />
          <div style={{ background: `${C.cyan}15`, border: `1px solid ${C.cyan}33`, borderRadius: 20, padding: "6px 16px", display: "inline-block" }}>
            <span style={{ fontSize: 13, fontFamily: "Arial, sans-serif", color: C.cyan }}>🥋 {memberCount.toLocaleString()} members worldwide</span>
          </div>
        </div>
        ...
        <div style={{ width: "100%", maxWidth: 360 }}>
          {resetMode ? (
            <>
              <div style={{ fontSize: 20, letterSpacing: 4, marginBottom: 8, textAlign: "center" }}>RESET PASSWORD</div>
              <div style={{ fontFamily: "Arial, sans-serif", fontSize: 13, color: C.gray, textAlign: "center", marginBottom: 20, lineHeight: 1.6 }}>
                {resetSent ? "✅ Reset email sent! Check your inbox." : "Enter your email and we'll send a reset link."}
              </div>
              {!resetSent && <input style={S.input} placeholder="Email" type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} />}
              {authError && <div style={{ background:"rgba(255,68,68,0.12)", border:"1px solid #FF444444", borderRadius:10, padding:"10px 14px", marginBottom:14, fontFamily:"Arial, sans-serif", fontSize:13, color:"#FF6666" }}>{authError}</div>}
              {!resetSent && <button style={S.btnPink} onClick={handleAuth} disabled={authLoading}>{authLoading ? "SENDING..." : "SEND RESET EMAIL"}</button>}
              <p style={{ marginTop: 14, fontSize: 13, fontFamily: "Arial, sans-serif", color: C.cyan, textAlign: "center", cursor: "pointer" }} onClick={() => { setResetMode(false); setResetSent(false); setAuthError(""); }}>← Back to Sign In</p>
            </>
          ) : (
            <>
              ...
              {authMode === "signup" && (
                <>
                  <div style={{ display:"flex", gap:10 }}>
                    <input style={{ ...S.input, flex:1 }} placeholder="First Name *" value={form.name.split(" ")[0]||""} onChange={e => setForm({ ...form, name: `${e.target.value} ${form.name.split(" ").slice(1).join(" ")}`.trim() })} />
                    <input style={{ ...S.input, flex:1 }} placeholder="Last Name *" value={form.name.split(" ").slice(1).join(" ")||""} onChange={e => setForm({ ...form, name: `${form.name.split(" ")[0]||""} ${e.target.value}`.trim() })} />
                  </div>
                  <div style={{ position:"relative" }}>
                    <input
                      style={{ ...S.input, paddingLeft:28, borderColor: usernameStatus==="available" ? C.green : usernameStatus==="taken" ? "#FF4444" : C.border }}
                      placeholder="Username (e.g. sweetpetemma) *"
                      value={form.username.replace("@","")}
                      onChange={async e => {
                        const raw = e.target.value.toLowerCase().replace(/[^a-z0-9_]/g,"");
                        setForm({ ...form, username: raw });
                        if (raw.length < 3) { setUsernameStatus(""); return; }
                        setUsernameStatus("checking");
                        const existing = await fbGet(`usernames/${raw}`);
                        setUsernameStatus(existing ? "taken" : "available");
                      }}
                    />
                    <span style={{ position:"absolute", left:10, top:"50%", transform:"translateY(-50%)", fontSize:13, color:C.gray, fontFamily:"Arial, sans-serif" }}>@</span>
                    {usernameStatus && (
                      <span style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", fontSize:11, fontFamily:"Arial, sans-serif", color: usernameStatus==="available" ? C.green : usernameStatus==="taken" ? "#FF4444" : C.gray }}>
                        {usernameStatus==="checking" ? "⏳" : usernameStatus==="available" ? "✅ Available" : "❌ Taken"}
                      </span>
                    )}
                  </div>
                  {usernameStatus==="taken" && <div style={{ fontFamily:"Arial, sans-serif", fontSize:11, color:"#FF4444", marginTop:-10, marginBottom:6, paddingLeft:4 }}>That username is taken — try another!</div>}
                </>
              )}
              <input style={S.input} placeholder="Email" type="email" inputMode="email" value={form.email} onChange={e => { setForm({ ...form, email: e.target.value }); setAuthError(""); }} />
              <input style={S.input} placeholder="Password (min 6 chars)" type="password" value={form.password} onChange={e => { setForm({ ...form, password: e.target.value }); setAuthError(""); }} />
              {authError && (
                <div style={{ background:"rgba(255,68,68,0.12)", border:"1px solid #FF444444", borderRadius:10, padding:"10px 14px", marginBottom:14, fontFamily:"Arial, sans-serif", fontSize:13, color:"#FF6666" }}>⚠️ {authError}</div>
              )}
              <button style={{ ...S.btnPink, opacity: authLoading ? 0.7 : 1 }} onClick={handleAuth} disabled={authLoading}>
                {authLoading ? "⏳ LOADING..." : authMode === "login" ? "SIGN IN" : "JOIN THE MANUAL"}
              </button>
              {authMode === "login" && (
                <p style={{ marginTop: 10, fontSize: 13, fontFamily: "Arial, sans-serif", color: C.gray, textAlign: "center", cursor: "pointer" }} onClick={() => { setResetMode(true); setAuthError(""); }}>
                  Forgot password? <span style={{ color: C.cyan }}>Reset it</span>
                </p>
              )}
              <p style={{ marginTop: 8, fontSize: 13, fontFamily: "Arial, sans-serif", color: C.gray, textAlign: "center", cursor: "pointer" }} onClick={() => { setAuthMode(authMode === "login" ? "signup" : "login"); setAuthError(""); }}>
                {authMode === "login"
                  ? <span>No account? <span style={{ color: C.cyan, fontWeight: "bold" }}>Sign up free</span></span>
                  : <span>Already a member? <span style={{ color: C.cyan, fontWeight: "bold" }}>Sign in</span></span>}
              </p>
            </>
          )}
        </div>
  ...
  if (selDiscipline && selCategory) {
    ...
    if (isUFCFighters && !selDrillCat) {
      ...
      const fighterMeta = {
        ...
        "Floyd Mayweather": { nickname: "Money",           weight: "Super WW",      flag: "🇺🇸", record: "50-0", belt: "🥊 Undefeated GOAT",    color: C.pink },
        "Canelo Alvarez":   { nickname: "Canelo",          weight: "Super MW",      flag: "🇲🇽", record: "62-2", belt: "🥊 Undisputed Champ",   color: C.pink },
        "Ryan Garcia":      { nickname: "KingRy",          weight: "Super Feather", flag: "🇺🇸", record: "24-1", belt: "",                      color: C.pink },
      };
        ...
        <div style={S.app}>
          <div style={{ ...S.pageHdr, background: `linear-gradient(135deg,rgba(204,0,0,0.3),#111)` }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray }}>BOXERS, UFC & BJJ FIGHTERS · {fighters.reduce((a, f) => a + (videos[selDiscipline]?.offense?.[f]?.length || 0), 0)} VIDEOS</div>
            </div>
    ...
    if (isBestMMA || isDrills || (isUFCFighters && selDrillCat)) {
      ...
      const eyebrow = isDrills ? "DRILLS" : isUFCFighters ? "BOXERS, UFC & BJJ FIGHTERS" : "MMA TECHNIQUES";
  ...
  if (activeTab === "community") {
    ...
    const UFC329_FIGHTS = [
      { id:1, order:"MAIN EVENT", weight:"170 lbs / Welterweight", card:"main",
        f1:{ name:"Conor McGregor", nickname:"The Notorious", record:"22-6", country:"🇮🇪", flag:"🇮🇪", height:'5\'9"', weight_lbs:"170", reach:'74"', stance:"Southpaw", odds:"+185" },
        f2:{ name:"Max Holloway",   nickname:"Blessed",       record:"27-9", country:"🇺🇸", flag:"🇺🇸", height:'5\'11"', weight_lbs:"170", reach:'69"', stance:"Orthodox", odds:"-225" } },
      { id:2, order:"CO-MAIN", weight:"155 lbs / Lightweight", card:"main",
        f1:{ name:"Paddy Pimblett", nickname:"The Baddy",    record:"23-4", country:"🇬🇧", flag:"🇬🇧", height:'5\'10"', weight_lbs:"155", reach:'73"', stance:"Orthodox", odds:"+124" },
        f2:{ name:"B. Saint Denis", nickname:"God of War",   record:"17-3", country:"🇫🇷", flag:"🇫🇷", height:'5\'11"', weight_lbs:"155", reach:'72"', stance:"Orthodox", odds:"-148" } },
      ...
      { id:4, order:"MAIN CARD", weight:"125 lbs / Flyweight", card:"main",
        f1:{ name:"Brandon Royval", nickname:"Raw Dawg",     record:"17-9", country:"🇺🇸", flag:"🇺🇸", height:'5\'6"', weight_lbs:"125", reach:'66"', stance:"Orthodox", odds:"+180" },
        f2:{ name:"Lone\'er Kavanagh", nickname:"—",        record:"11-1", country:"🇬🇧", flag:"🇬🇧", height:'5\'6"', weight_lbs:"125", reach:'66"', stance:"Orthodox", odds:"-218" } },
      { id:5, order:"MAIN CARD", weight:"155 lbs / Lightweight", card:"main",
        f1:{ name:"King Green",      nickname:"King",        record:"35-15", country:"🇺🇸", flag:"🇺🇸", height:'6\'0"', weight_lbs:"155", reach:'75"', stance:"Orthodox", odds:"+110" },
        f2:{ name:"T. McKinney",     nickname:"Hardbody",    record:"16-7", country:"🇺🇸", flag:"🇺🇸", height:'5\'11"', weight_lbs:"155", reach:'74"', stance:"Orthodox", odds:"-134" } },
    ...
    const sendHubMsg = async (isPoll = false, pollData = null) => {
      ...
      // Update local state immediately so it shows in JSX preview and before Firebase sync
      setHubMessages(prev => ({ ...prev, [activeHubGroup]: [...(prev[activeHubGroup] || []), { ...newMsg, _key: `local_${Date.now()}` }] }));
      // Also push to Firebase for persistence
      fbPush(`hub_messages/${activeHubGroup}`, newMsg);
      setHubMsgInput("");
      setHubReplyTo(null);
    };
    ...
    const votePoll = async (msgIdx, optIdx) => {
      ...
      setHubMessages(prev => {
        const groupMsgs = [...(prev[activeHubGroup] || [])];
        const m = { ...groupMsgs[msgIdx] };
        const options = m.options.map(opt => ({ ...opt, votes: { ...(opt.votes || {}) } }));
        ...
        if (!(msg.options[optIdx].votes || {})[user.name]) {
          options[optIdx].votes[user.name] = true;
        }
        groupMsgs[msgIdx] = { ...m, options };
        return { ...prev, [activeHubGroup]: groupMsgs };
      });

      // Also update Firebase if we have a real key
      if (msg._key && !msg._key.startsWith("local_")) {
        ...
        fbPatch(`hub_messages/${activeHubGroup}/${msg._key}`, { options });
      }
    };
      ...
      <div style={S.app}>
        <div style={{ ...S.header, borderBottomColor:"#CC0000" }}>
          ...
          <div style={{ display:"flex", gap:8, alignItems:"center" }}>
            <div style={{ background:`${C.cyan}15`, border:`1px solid ${C.cyan}33`, borderRadius:20, padding:"4px 10px", fontSize:11, fontFamily:"Arial, sans-serif", color:C.cyan }}>{memberCount.toLocaleString()} 👥</div>
            <div style={S.avatar} onClick={() => setActiveTab("profile")}>{user.name[0].toUpperCase()}</div>
          </div>
        </div>

        {/* Groups / Members toggle */}
        <div style={{ display:"flex", borderBottom:`1px solid ${C.border}` }}>
          {[["groups","💬 GROUPS"],["members","🔍 MEMBERS"]].map(([id,label]) => (
            <div key={id} onClick={() => setHubView(id)} style={{ flex:1, padding:"12px 4px", textAlign:"center", fontSize:13, fontFamily:"Arial, sans-serif", letterSpacing:1, color:hubView===id ? "#CC0000" : C.gray, borderBottom:`2px solid ${hubView===id ? "#CC0000" : "transparent"}`, cursor:"pointer" }}>{label}</div>
          ))}
        </div>
        ...
        {hubView === "members" && (
          <div style={{ padding:"14px 16px" }}>
            ...
            {memberSearch.trim() === "" ? (
              <div style={{ textAlign:"center", padding:"30px 0", fontFamily:"Arial, sans-serif", color:C.gray, fontSize:13 }}>
                Search for fighters and members by name, username, or email 🥋
              </div>
            ) : (
              (() => {
                ...
                return filtered.length === 0 ? (
                  <div style={{ textAlign:"center", padding:"30px 0", fontFamily:"Arial, sans-serif", color:C.gray, fontSize:13 }}>No members found for "{memberSearch}"</div>
                ) : filtered.map((m, i) => (
                  <div key={i} style={{ ...S.card, padding:"14px", marginBottom:10 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                      <div style={{ width:44, height:44, borderRadius:"50%", background:`linear-gradient(135deg,${C.pink},${C.cyan})`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:18, flexShrink:0 }}>
                        {(m.firstName || m.name || "?")[0].toUpperCase()}
                      </div>
                      <div style={{ flex:1 }}>
                        <div style={{ fontSize:15, letterSpacing:1 }}>{m.firstName && m.lastName ? `${m.firstName} ${m.lastName}` : m.name}</div>
                        <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.cyan, marginTop:2 }}>{m.username || `@${(m.name||"fighter").toLowerCase().replace(/\s/g,"")}`}</div>
                        <div style={{ display:"flex", gap:8, marginTop:4 }}>
                          {m.baseMart && <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.pink, background:`${C.pink}15`, borderRadius:10, padding:"2px 8px" }}>{m.baseMart}</span>}
                          {m.bjjBelt && m.bjjBelt !== "N/A" && <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gold, background:`${C.gold}15`, borderRadius:10, padding:"2px 8px" }}>🥋 {m.bjjBelt} Belt</span>}
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  if (activeTab === "coaching") {
    ...
    const ringBell = () => {
      try {
        ...
        ring(800, 0, 1.5); ring(600, 0.05, 1.2); ring(1000, 0.1, 0.8);
        ring(800, 1.8, 1.5); ring(600, 1.85, 1.2); ring(1000, 1.9, 0.8);
      } catch(e) {}
    };

    // ── PRACTICE PLANNER CONSTANTS ──
    const WARMUP_OPTIONS = ["Jogging / Light Cardio", "Jump Rope", "Shadowboxing", "Dynamic Stretching", "Breakfalls & Rolls", "Pummelling Drills", "Shrimping & Hip Escapes", "Takedown Level Changes", "Partner Resistance Drills", "Resistance Band Work"];
    const DRILL_OPTIONS  = ["Technique Drilling (from video)", "Pad Work", "Bag Work", "Partner Drilling", "Positional Sparring", "Flow Rolling", "Takedown Drilling", "Guard Passing Drill", "Clinch Work", "Footwork Drill"];
    const COOL_OPTIONS   = ["Static Stretching", "Partner Stretching", "Cool Down Jog", "Breathing Exercises", "Foam Rolling", "Ice Bath / Recovery", "Team Talk & Debrief"];

    const startRollingTimer = (config) => {
      if (rollingInterval) { clearInterval(rollingInterval); setRollingInterval(null); }
      const totalSec = config.roundDuration * 60;
      setRollingTimer({ ...config, running: true, timeLeft: totalSec, onBreak: false, round: 1, done: false });
      const interval = setInterval(() => {
        setRollingTimer(prev => {
          if (!prev.running || prev.done) { clearInterval(interval); return prev; }
          if (prev.timeLeft <= 1) {
            // Round or break finished
            if (prev.onBreak) {
              // Break done — start next round
              if (prev.round >= prev.totalRounds) {
                ringBell();
                clearInterval(interval);
                return { ...prev, running: false, done: true, timeLeft: 0 };
              }
              ringBell();
              return { ...prev, round: prev.round + 1, onBreak: false, timeLeft: prev.roundDuration * 60 };
            } else {
              ...
              return { ...prev, onBreak: true, timeLeft: prev.breakDuration * 60 };
            }
          }
    ...
    const stopRollingTimer = () => {
      if (rollingInterval) { clearInterval(rollingInterval); setRollingInterval(null); }
      setRollingTimer(prev => ({ ...prev, running: false }));
    };

    const fmtTime = (secs) => `${Math.floor(secs/60)}:${String(secs%60).padStart(2,"0")}`;

    // ── PRACTICE PLANNER VIEW ──
    if (coachingView === "planner") {
      const plan = practicePlan || { title: "Practice Plan", date: new Date().toLocaleDateString(), totalMins: 60, blocks: [
        { id:1, type:"warmup",    label:"Warmup",    mins:10, activity:"Jogging / Light Cardio", notes:"" },
        { id:2, type:"technique", label:"Technique", mins:20, videoTitle:"", notes:"" },
        { id:3, type:"drilling",  label:"Drilling",  mins:15, activity:"Pad Work", notes:"" },
        { id:4, type:"rolling",   label:"Rolling",   mins:10, rounds:3, roundMins:3, breakMins:1, notes:"" },
        { id:5, type:"cooldown",  label:"Cooldown",  mins:5,  activity:"Static Stretching", notes:"" },
      ]};

      const blockColor = { warmup:"#FF9500", technique:C.pink, drilling:C.cyan, rolling:"#CC0000", cooldown:C.green };
      const totalPlanned = plan.blocks.reduce((a,b) => a + (parseInt(b.mins)||0), 0);

      const updateBlock = (id, field, val) => setPracticePlan(p => {
        const blocks = (p||plan).blocks.map(b => b.id === id ? { ...b, [field]: val } : b);
        return { ...(p||plan), blocks };
      });
      ...
      return (
        <div style={{ ...S.app, overflowY:"auto" }}>
          <div style={{ ...S.header, borderBottomColor: C.gold }}>
            ...
            <div style={{ flex:1 }}>
              <div style={{ fontSize:16, letterSpacing:3, color:C.gold }}>📋 PRACTICE PLANNER</div>
              <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>{totalPlanned} / {plan.totalMins} min planned</div>
            </div>
            <button onClick={() => {
              const saved = { ...plan, savedAt: new Date().toLocaleString() };
              setPracticeLog(prev => [saved, ...prev]);
              fbPush(`practice_logs/${userTeam?.id || "default"}`, saved);
              alert("Practice saved! ✅");
            }} style={{ background:`${C.gold}22`, border:`1px solid ${C.gold}55`, borderRadius:20, padding:"6px 12px", fontSize:11, color:C.gold, cursor:"pointer", fontFamily:"Arial, sans-serif" }}>💾 SAVE</button>
          </div>
          ...
          <div style={{ padding:"10px 16px 0" }}>
            <div style={{ display:"flex", gap:2, height:8, borderRadius:6, overflow:"hidden", marginBottom:6 }}>
              {plan.blocks.map(b => (
                <div key={b.id} style={{ flex: parseInt(b.mins)||0, background: blockColor[b.type], minWidth:2 }} />
              ))}
              {totalPlanned < plan.totalMins && <div style={{ flex: plan.totalMins - totalPlanned, background: "rgba(255,255,255,0.08)" }} />}
            </div>
            <div style={{ fontFamily:"Arial, sans-serif", fontSize:10, color: totalPlanned > plan.totalMins ? "#FF4444" : C.gray, textAlign:"right" }}>
              {totalPlanned > plan.totalMins ? `⚠️ ${totalPlanned - plan.totalMins} min over` : `${plan.totalMins - totalPlanned} min remaining`}
            </div>
          </div>
          ...
          <div style={{ padding:"10px 16px" }}>
            {plan.blocks.map((block, bi) => (
              <div key={block.id} style={{ background:`${blockColor[block.type]}12`, border:`1px solid ${blockColor[block.type]}44`, borderRadius:14, padding:"14px", marginBottom:12 }}>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:10 }}>
                  <div style={{ fontSize:14, letterSpacing:2, color:blockColor[block.type] }}>{block.label.toUpperCase()}</div>
                  <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                    <input type="number" value={block.mins} onChange={e => updateBlock(block.id,"mins",e.target.value)} style={{ width:44, background:"rgba(255,255,255,0.08)", border:`1px solid ${blockColor[block.type]}44`, borderRadius:8, color:C.white, fontSize:13, padding:"4px 6px", textAlign:"center" }} />
                    <span style={{ fontFamily:"Arial, sans-serif", fontSize:11, color:C.gray }}>min</span>
                  </div>
                </div>

                {/* Warmup */}
                {block.type === "warmup" && (
                  <select value={block.activity} onChange={e => updateBlock(block.id,"activity",e.target.value)} style={{ ...S.input, marginBottom:8, fontSize:13 }}>
                ...
                {block.type === "technique" && (
                  <div style={{ marginBottom:8 }}>
                    <input style={{ ...S.input, marginBottom:6, fontSize:13 }} placeholder="Search or type a technique..." value={block.videoTitle} onChange={e => updateBlock(block.id,"videoTitle",e.target.value)} />
                    {block.videoTitle && (
                      <div style={{ background:"rgba(255,255,255,0.04)", borderRadius:10, padding:"6px 10px", fontSize:11, fontFamily:"Arial, sans-serif", color:C.cyan }}>
                        📹 {block.videoTitle}
                      </div>
                    )}
                  </div>
                ...
                {block.type === "rolling" && (
                  <div>
                    <div style={{ display:"flex", gap:10, marginBottom:10, flexWrap:"wrap" }}>
                      {[["Rounds",block.rounds||3,"rounds"],["Round Dur",block.roundMins||5,"min"],["Break",block.breakMins||1,"min"]].map(([label,val,unit],i) => (
                        <div key={i} style={{ flex:1, minWidth:80 }}>
                          <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray, marginBottom:4 }}>{label}</div>
                          <input type="number" value={val} min={i===0?1:3} max={i===0?20:10} onChange={e => updateBlock(block.id, i===0?"rounds":i===1?"roundMins":"breakMins", parseInt(e.target.value))} style={{ width:"100%", background:"rgba(255,255,255,0.08)", border:`1px solid rgba(204,0,0,0.4)`, borderRadius:8, color:C.white, fontSize:14, padding:"6px 8px", textAlign:"center" }} />
                          <div style={{ fontSize:9, fontFamily:"Arial, sans-serif", color:C.gray, textAlign:"center", marginTop:2 }}>{unit}</div>
                        </div>
                      ))}
                    </div>
                    {/* Rolling Timer */}
                    <div style={{ background:"rgba(204,0,0,0.1)", border:"1px solid rgba(204,0,0,0.3)", borderRadius:12, padding:"14px", textAlign:"center" }}>
                      {rollingTimer.done ? (
                        <div style={{ fontSize:18, color:C.green }}>🔔 Session Complete!</div>
                      ) : (
                        <>
                          <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, marginBottom:4 }}>
                            {rollingTimer.running ? (rollingTimer.onBreak ? "🔴 BREAK" : "⚡ ROUND") : "READY"} {rollingTimer.running ? `${rollingTimer.round}/${rollingTimer.totalRounds}` : ""}
                          </div>
                          <div style={{ fontSize:48, color: rollingTimer.onBreak ? C.gold : "#CC0000", fontFamily:"Arial, sans-serif", fontWeight:"bold", lineHeight:1 }}>
                            {fmtTime(rollingTimer.running ? rollingTimer.timeLeft : (block.roundMins||5)*60)}
                          </div>
                          <div style={{ display:"flex", gap:10, marginTop:12, justifyContent:"center" }}>
                            {!rollingTimer.running ? (
                              <button onClick={() => startRollingTimer({ totalRounds: block.rounds||3, roundDuration: block.roundMins||5, breakDuration: block.breakMins||1 })} style={{ ...S.btnPink, background:"#CC0000", padding:"10px 28px", fontSize:16 }}>🔔 START</button>
                            ) : (
                              <>
                                <button onClick={stopRollingTimer} style={{ ...S.btnCyan, padding:"10px 20px", fontSize:14 }}>⏸ PAUSE</button>
                                <button onClick={() => { stopRollingTimer(); setRollingTimer(prev => ({ ...prev, done:false, round:1, timeLeft:(block.roundMins||5)*60, onBreak:false })); }} style={{ background:"rgba(255,255,255,0.08)", border:`1px solid ${C.border}`, borderRadius:10, padding:"10px 20px", color:C.gray, fontSize:14, cursor:"pointer" }}>↺ RESET</button>
                              </>
                            )}
                          </div>
                        </>
                ...
                {block.type === "cooldown" && (
                  <select value={block.activity} onChange={e => updateBlock(block.id,"activity",e.target.value)} style={{ ...S.input, marginBottom:8, fontSize:13 }}>
                    {COOL_OPTIONS.map(o => <option key={o} value={o}>{o}</option>)}
                  </select>
                )}

                {/* Notes */}
                <input style={{ ...S.input, marginBottom:0, fontSize:12, background:"rgba(255,255,255,0.03)" }} placeholder="Coach notes (optional)..." value={block.notes||""} onChange={e => updateBlock(block.id,"notes",e.target.value)} />
              </div>
            ))}

            {/* Assign to team button */}
            {userTeam && (
              <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${C.gold},#CC8800)`, color:"#000", marginTop:8 }} onClick={async () => {
                const saved = { ...plan, assignedTo:"team", assignedAt: new Date().toLocaleString() };
                await fbPush(`team_drills/${userTeam.id}`, { title: `Practice Plan: ${plan.title}`, note:"Full practice plan assigned", ts:Date.now(), time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}) });
                setTeachingLog(prev => [{ ...saved, done:false }, ...prev]);
                alert("Practice plan assigned to team! ✅");
              }}>📤 ASSIGN TO TEAM</button>
            )}
          </div>
          <div style={{ height:90 }} />
    ...
    // ── MY GROUPS VIEW ──
    if (coachingView === "groups") {
      const GROUP_TYPES = ["BJJ Class", "BJJ Team", "BJJ Competitive", "MMA Team", "Kids Class", "Striking Class", "Wrestling Team", "Gi Class", "No-Gi Class", "Private Students"];
      const GROUP_COLORS = ["#FF1493","#00CFFF","#FFD700","#00E676","#9B5CFF","#FF6B35","#CC0000","#00BCD4","#E91E63","#4CAF50"];

      return (
        <div style={{ ...S.app, overflowY:"auto" }}>
          <div style={{ ...S.header, borderBottomColor:C.cyan }}>
            <button style={S.backBtn} onClick={() => setCoachingView("home")}>←</button>
            <div style={{ fontSize:16, letterSpacing:3, color:C.cyan }}>👥 MY GROUPS</div>
            <button onClick={() => setCreateGroupModal(true)} style={{ background:`${C.cyan}22`, border:`1px solid ${C.cyan}44`, borderRadius:20, padding:"6px 12px", fontSize:11, color:C.cyan, cursor:"pointer", fontFamily:"Arial, sans-serif" }}>+ NEW</button>
          </div>
          ...
          <div style={{ padding:"14px 16px" }}>
            {coachGroups.length === 0 ? (
              <div style={{ textAlign:"center", padding:"40px 20px", fontFamily:"Arial, sans-serif" }}>
                ...
                <div style={{ fontSize:16, letterSpacing:2, color:C.cyan, marginBottom:8 }}>NO GROUPS YET</div>
                <div style={{ fontSize:13, color:C.gray, marginBottom:20, lineHeight:1.7 }}>Create your first group — BJJ Class, MMA Team, Competitive Squad, and more. Each gets its own chat, drills, and practice planner.</div>
                <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${C.cyan},#0099CC)`, color:"#000" }} onClick={() => setCreateGroupModal(true)}>+ CREATE FIRST GROUP</button>
              </div>
            ) : (
              coachGroups.map((group, i) => {
                const msgs = groupMessages[group.id] || [];
                const drills = groupDrills[group.id] || [];
                const reqs = groupRequests[group.id] || [];
                const pendingReqs = reqs.filter(r => r.status === "pending").length;
                return (
                  <div key={group.id} onClick={() => { setActiveGroup(group); setCoachingView("groupchat"); setGroupView("chat"); }} style={{ background:C.card, border:`2px solid ${group.color}44`, borderRadius:16, padding:"16px", marginBottom:12, cursor:"pointer" }}>
                    <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                      <div style={{ width:48, height:48, borderRadius:14, background:`linear-gradient(135deg,${group.color},${group.color}88)`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, flexShrink:0 }}>
                        {group.type === "BJJ Class" || group.type === "BJJ Team" || group.type === "BJJ Competitive" || group.type === "Gi Class" || group.type === "No-Gi Class" ? "🥋" :
                         group.type === "MMA Team" ? "⚡" :
                         group.type === "Kids Class" ? "⭐" :
                         group.type === "Wrestling Team" ? "💪" :
                         group.type === "Striking Class" ? "🥊" : "👥"}
                      </div>
                      <div style={{ flex:1 }}>
                        <div style={{ fontSize:16, letterSpacing:1, color:C.white }}>{group.name}</div>
                        <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:group.color, marginTop:2 }}>{group.type}</div>
                        <div style={{ display:"flex", gap:10, marginTop:6 }}>
                          <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>💬 {msgs.length} msgs</span>
                          <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>📋 {drills.length} drills</span>
                          <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>👥 {group.members?.length || 0} members</span>
                          {pendingReqs > 0 && <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gold }}>🔔 {pendingReqs} requests</span>}
                        </div>
                      </div>
                      <div style={{ color:group.color, fontSize:20 }}>›</div>
                    </div>
                  </div>
                );
              })
          ...
          {createGroupModal && (
            <div style={S.modal}>
              <div style={{ ...S.modalBox, maxHeight:"80vh", overflowY:"auto" }}>
                <div style={{ fontSize:18, letterSpacing:3, color:C.cyan, marginBottom:14 }}>👥 CREATE GROUP</div>
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:8 }}>GROUP NAME</div>
                <input style={S.input} placeholder="e.g. BJJ Competitive Team *" value={createGroupForm.name} onChange={e => setCreateGroupForm(p => ({...p, name:e.target.value}))} />
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:8 }}>GROUP TYPE</div>
                <div style={{ display:"flex", flexWrap:"wrap", gap:8, marginBottom:16 }}>
                  {GROUP_TYPES.map(t => (
                    <div key={t} onClick={() => setCreateGroupForm(p => ({...p, type:t}))} style={{ padding:"7px 14px", borderRadius:20, border:`1px solid ${createGroupForm.type===t ? C.cyan : C.border}`, background:createGroupForm.type===t ? `${C.cyan}22` : "rgba(255,255,255,0.04)", color:createGroupForm.type===t ? C.cyan : C.gray, fontSize:12, fontFamily:"Arial, sans-serif", cursor:"pointer" }}>{t}</div>
                  ))}
                </div>
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:8 }}>GROUP COLOR</div>
                <div style={{ display:"flex", gap:8, marginBottom:16, flexWrap:"wrap" }}>
                  {GROUP_COLORS.map(col => (
                    <div key={col} onClick={() => setCreateGroupForm(p => ({...p, color:col}))} style={{ width:36, height:36, borderRadius:"50%", background:col, border:`3px solid ${createGroupForm.color===col ? C.white : "transparent"}`, cursor:"pointer" }} />
                  ))}
                </div>
                <button style={{ ...S.btnPink, background:createGroupForm.name.trim()?`linear-gradient(135deg,${C.cyan},#0099CC)`:"rgba(255,255,255,0.1)", color:createGroupForm.name.trim()?"#000":C.gray }} onClick={() => {
                  if (!createGroupForm.name.trim()) return;
                  const newGroup = { id:`group_${Date.now()}`, name:createGroupForm.name.trim(), type:createGroupForm.type, color:createGroupForm.color, members:[], createdAt:new Date().toLocaleDateString() };
                  setCoachGroups(prev => [...prev, newGroup]);
                  setCreateGroupModal(false);
                  setCreateGroupForm({ name:"", type:"BJJ Class", color:"#FF1493" });
                  // Open the new group immediately
                  setActiveGroup(newGroup);
                  setCoachingView("groupchat");
                  setGroupView("chat");
                }}>CREATE GROUP</button>
                <button style={S.btnCyan} onClick={() => setCreateGroupModal(false)}>CANCEL</button>
              </div>
            </div>
          )}
        </div>
    ...
    // ── GROUP CHAT VIEW ──
    if (coachingView === "groupchat" && activeGroup) {
      ...
      const sendGroupMsg = async (isPoll=false, pollData=null) => {
        if (!isPoll && !groupMsgInput.trim()) return;
        const newMsg = isPoll ? {
          ...
          author:user.name, avatar:user.name[0].toUpperCase(), ts:Date.now(),
          time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),
          text:groupMsgInput.trim(), replyTo:groupReplyTo||null, reactions:{}, type:"text"
        };
        setGroupMessages(prev => ({ ...prev, [group.id]: [...(prev[group.id]||[]), {...newMsg, _key:`local_${Date.now()}`}] }));
        fbPush(`group_messages/${group.id}`, newMsg);
        setGroupMsgInput(""); setGroupReplyTo(null);
      };

      const addGroupReaction = async (msgIdx, emoji) => {
        setGroupMessages(prev => {
          const msgs = [...(prev[group.id]||[])];
          const m = { ...msgs[msgIdx] };
          ...
          msgs[msgIdx] = { ...m, reactions };
          return { ...prev, [group.id]: msgs };
        });
        setGroupEmojiPicker(null);
      };

      const voteGroupPoll = (msgIdx, optIdx) => {
        setGroupMessages(prev => {
          const msgs = [...(prev[group.id]||[])];
          const m = { ...msgs[msgIdx] };
          if (m.type !== "poll") return prev;
          const options = m.options.map(opt => ({ ...opt, votes:{ ...(opt.votes||{}) } }));
          options.forEach(opt => delete opt.votes[user.name]);
          if (!(m.options[optIdx].votes||{})[user.name]) options[optIdx].votes[user.name] = true;
          msgs[msgIdx] = { ...m, options };
          return { ...prev, [group.id]: msgs };
        });
      };

      const submitGroupPoll = () => {
        const opts = groupPollForm.options.filter(o=>o.trim());
        if (!groupPollForm.question.trim() || opts.length < 2) return;
        sendGroupMsg(true, { question:groupPollForm.question, options:opts });
        setGroupPollModal(false); setGroupPollForm({ question:"", options:["",""] });
      };

      return (
        <div style={{ ...S.app, display:"flex", flexDirection:"column" }} onClick={() => setGroupEmojiPicker(null)}>
          {/* Header */}
          <div style={{ ...S.header, borderBottomColor:group.color }}>
            <button style={S.backBtn} onClick={() => { setCoachingView("groups"); setActiveGroup(null); }}>←</button>
            <div style={{ flex:1 }}>
              <div style={{ fontSize:15, letterSpacing:2, color:group.color }}>{group.name}</div>
              <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>{group.type} · {group.members?.length||0} members</div>
            </div>
            <button onClick={() => setGroupPollModal(true)} style={{ background:`${C.gold}22`, border:`1px solid ${C.gold}44`, borderRadius:20, padding:"5px 10px", fontSize:10, color:C.gold, cursor:"pointer", fontFamily:"Arial, sans-serif", marginRight:6 }}>📊</button>
          </div>

          {/* Sub-tabs */}
          <div style={{ display:"flex", borderBottom:`1px solid ${C.border}`, overflowX:"auto" }}>
            {[["chat","💬 CHAT"],["drills","📋 DRILLS"],["requests","🙋 REQUESTS"],["members","👥 MEMBERS"],["planner","⏱ PLANNER"]].map(([id,label]) => (
              <div key={id} onClick={() => setGroupView(id)} style={{ flex:"0 0 auto", padding:"10px 12px", textAlign:"center", fontSize:10, fontFamily:"Arial, sans-serif", letterSpacing:1, color:groupView===id?group.color:C.gray, borderBottom:`2px solid ${groupView===id?group.color:"transparent"}`, cursor:"pointer" }}>{label}</div>
            ))}
          </div>
          ...
          {groupView === "chat" && (
            <>
              <div style={{ flex:1, padding:"12px 14px", overflowY:"auto" }}>
                {msgs.length === 0 && <div style={{ textAlign:"center", padding:"30px 0", fontFamily:"Arial, sans-serif", color:C.gray, fontSize:13 }}>No messages yet — start the group conversation! 💬</div>}
                {msgs.map((m,i) => {
                  const totalV = m.type==="poll" ? m.options?.reduce((a,o)=>a+Object.keys(o.votes||{}).length,0)||0 : 0;
                  return (
                    <div key={i} style={{ marginBottom:14 }}>
                      {m.replyTo && <div style={{ marginLeft:36, marginBottom:4, background:"rgba(255,255,255,0.04)", borderLeft:`2px solid ${C.gray}`, borderRadius:"0 8px 8px 0", padding:"4px 10px" }}><div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>↩ @{m.replyTo.author}: {m.replyTo.text?.slice(0,40)}</div></div>}
                      <div style={{ display:"flex", gap:8, alignItems:"flex-start" }}>
                        <div style={{ width:30, height:30, borderRadius:"50%", background:`linear-gradient(135deg,${group.color},${group.color}88)`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, flexShrink:0 }}>{m.avatar}</div>
                        <div style={{ flex:1 }}>
                          <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:3 }}>
                            <span style={{ fontFamily:"Arial, sans-serif", fontSize:12, color:group.color, fontWeight:"bold" }}>@{m.author}</span>
                            <span style={{ fontFamily:"Arial, sans-serif", fontSize:10, color:C.gray }}>{m.time}</span>
                            {m.author===user.name && isCoach && <span style={{ fontSize:9, background:`${C.gold}22`, color:C.gold, borderRadius:10, padding:"1px 6px", fontFamily:"Arial, sans-serif" }}>COACH</span>}
                          </div>
                          {m.type==="poll" ? (
                            <div style={{ background:`${group.color}0D`, border:`1px solid ${group.color}33`, borderRadius:12, padding:"12px" }}>
                              <div style={{ fontSize:13, fontFamily:"Arial, sans-serif", color:C.white, marginBottom:10, fontWeight:"bold" }}>📊 {m.question}</div>
                              {(m.options||[]).map((opt,oi) => {
                                const pct = totalV>0 ? Math.round(Object.keys(opt.votes||{}).length/totalV*100) : 0;
                                const voted = (opt.votes||{})[user.name];
                                return (
                                  <div key={oi} onClick={() => voteGroupPoll(i,oi)} style={{ marginBottom:8, cursor:"pointer" }}>
                                    <div style={{ display:"flex", justifyContent:"space-between", marginBottom:4 }}>
                                      <span style={{ fontFamily:"Arial, sans-serif", fontSize:12, color:voted?group.color:C.white }}>{voted?"✓ ":""}{opt.text}</span>
                                      <span style={{ fontFamily:"Arial, sans-serif", fontSize:12, color:C.gray }}>{pct}% ({Object.keys(opt.votes||{}).length})</span>
                                    </div>
                                    <div style={{ height:6, background:"rgba(255,255,255,0.08)", borderRadius:3, overflow:"hidden" }}>
                                      <div style={{ height:"100%", width:`${pct}%`, background:voted?group.color:C.gray, borderRadius:3, transition:"width 0.3s" }} />
                                    </div>
                                  </div>
                                );
                              })}
                          ...
                          <div style={{ display:"flex", gap:6, marginTop:8, flexWrap:"wrap", alignItems:"center" }}>
                            {Object.entries(m.reactions||{}).filter(([,u])=>u&&Object.keys(u).length>0).map(([emoji,users]) => (
                              <div key={emoji} onClick={() => addGroupReaction(i,emoji)} style={{ background:users[user.name]?`${group.color}22`:"rgba(255,255,255,0.06)", border:`1px solid ${users[user.name]?group.color+"66":C.border}`, borderRadius:20, padding:"3px 8px", fontSize:13, cursor:"pointer", display:"flex", alignItems:"center", gap:3 }}>
                                {emoji}<span style={{ fontFamily:"Arial, sans-serif", fontSize:11, color:C.gray }}>{Object.keys(users).length}</span>
                              </div>
                            ))}
                            <div onClick={() => addGroupReaction(i,"👍")} style={{ background:"rgba(255,255,255,0.04)", border:`1px solid ${C.border}`, borderRadius:20, padding:"3px 8px", fontSize:13, cursor:"pointer" }}>👍 {Object.keys(m.reactions?.["👍"]||{}).length||""}</div>
                            <div onClick={() => setGroupEmojiPicker(groupEmojiPicker===i?null:i)} style={{ background:"rgba(255,255,255,0.04)", border:`1px solid ${C.border}`, borderRadius:20, padding:"3px 8px", fontSize:13, cursor:"pointer" }}>😀</div>
                            <div onClick={() => setGroupReplyTo({ author:m.author, text:m.text||m.question })} style={{ background:"rgba(255,255,255,0.04)", border:`1px solid ${C.border}`, borderRadius:20, padding:"3px 8px", fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, cursor:"pointer" }}>↩</div>
                          </div>
                          {groupEmojiPicker===i && (
                            <div onClick={e=>e.stopPropagation()} style={{ display:"flex", flexWrap:"wrap", gap:6, marginTop:8, background:C.card, border:`1px solid ${C.border}`, borderRadius:12, padding:"10px" }}>
                              {QUICK_EMOJIS_G.map(emoji => <div key={emoji} onClick={() => addGroupReaction(i,emoji)} style={{ fontSize:20, cursor:"pointer", padding:"4px" }}>{emoji}</div>)}
                            </div>
                          )}
                        </div>
                      </div>
              ...
              {groupReplyTo && (
                <div style={{ padding:"6px 14px", background:"rgba(255,255,255,0.04)", borderTop:`1px solid ${C.border}`, display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                  <div style={{ fontFamily:"Arial, sans-serif", fontSize:11, color:C.gray }}>↩ @{groupReplyTo.author}</div>
                  <button onClick={() => setGroupReplyTo(null)} style={{ background:"none", border:"none", color:C.gray, fontSize:16, cursor:"pointer" }}>✕</button>
                </div>
              )}
              <div style={{ padding:"10px 14px", borderTop:`1px solid ${C.border}`, display:"flex", gap:8 }}>
                <input style={{ ...S.input, marginBottom:0, flex:1, fontSize:14, padding:"12px 14px" }} placeholder={`Message ${group.name}...`} value={groupMsgInput} onChange={e=>setGroupMsgInput(e.target.value)} onKeyDown={e=>e.key==="Enter"&&sendGroupMsg()} />
                <button style={{ background:group.color, border:"none", borderRadius:10, padding:"0 16px", color:"#000", fontSize:18, cursor:"pointer" }} onClick={()=>sendGroupMsg()}>↑</button>
              </div>
            </>
          )}
          ...
          {groupView === "drills" && (
            <div style={{ flex:1, padding:"14px 16px", overflowY:"auto" }}>
              {isCoach && (
                <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${group.color},${group.color}88)`, color:"#000", marginBottom:16 }} onClick={() => setGroupAssignDrillModal(true)}>
                  📋 ASSIGN DRILL OR TECHNIQUE
                </button>
              )}
              {drills.length === 0 && <div style={{ textAlign:"center", padding:"30px 0", fontFamily:"Arial, sans-serif", color:C.gray }}>{isCoach?"Assign your first drill to this group!":"No drills assigned yet."}</div>}
              {drills.map((d,i) => (
                <div key={i} style={{ ...S.card, padding:"14px", marginBottom:10 }}>
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                    <div style={{ flex:1 }}>
                      <div style={{ fontSize:14, letterSpacing:1 }}>{d.title}</div>
                      {d.note && <div style={{ fontSize:12, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:4 }}>📝 {d.note}</div>}
                      <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:group.color, marginTop:4 }}>Assigned {d.time}</div>
                    </div>
                    <div style={{ display:"flex", flexDirection:"column", gap:6, alignItems:"flex-end" }}>
                      {d.youtubeUrl && <button onClick={() => window.open(d.youtubeUrl,"_blank")} style={{ background:`${C.pink}22`, border:`1px solid ${C.pink}44`, borderRadius:8, padding:"5px 10px", fontSize:11, color:C.pink, cursor:"pointer" }}>▶ Watch</button>}
                      {isCoach && <button onClick={async () => { await fbPatch(`group_drills/${group.id}/${d._key}`, { done:true }); setGroupDrills(prev => ({ ...prev, [group.id]: (prev[group.id]||[]).map((x,xi) => xi===i?{...x,done:true}:x) })); }} style={{ background:d.done?`${C.green}22`:"rgba(255,255,255,0.06)", border:`1px solid ${d.done?C.green:C.border}`, borderRadius:8, padding:"5px 10px", fontSize:11, color:d.done?C.green:C.gray, cursor:"pointer" }}>{d.done?"✅ DONE":"✓ MARK DONE"}</button>}
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div style={{ flex:1, padding:"14px 16px", overflowY:"auto" }}>
              {!isCoach && (
                <div style={{ marginBottom:16 }}>
                  <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:8 }}>REQUEST A DRILL OR TECHNIQUE</div>
                  <div style={{ display:"flex", gap:8 }}>
                    <input style={{ ...S.input, marginBottom:0, flex:1 }} placeholder="What do you want to learn?" value={groupDrillReqInput} onChange={e=>setGroupDrillReqInput(e.target.value)} />
                    <button style={{ background:group.color, border:"none", borderRadius:10, padding:"0 14px", color:"#000", fontSize:16, cursor:"pointer" }} onClick={async () => {
                      if (!groupDrillReqInput.trim()) return;
                      const req = { text:groupDrillReqInput.trim(), from:user.name, ts:Date.now(), time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}), status:"pending" };
                      setGroupRequests(prev => ({ ...prev, [group.id]: [...(prev[group.id]||[]), { ...req, _key:`local_${Date.now()}` }] }));
                      fbPush(`group_requests/${group.id}`, req);
                      setGroupDrillReqInput("");
                    }}>→</button>
                  </div>
                </div>
              )}
              {reqs.length === 0 && <div style={{ textAlign:"center", padding:"30px 0", fontFamily:"Arial, sans-serif", color:C.gray }}>No requests yet.</div>}
              {[...reqs].reverse().map((req,i) => (
                <div key={i} style={{ ...S.card, padding:"14px", marginBottom:10 }}>
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                    <div style={{ flex:1 }}>
                      <div style={{ fontSize:14 }}>{req.text}</div>
                      <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:3 }}>@{req.from} · {req.time}</div>
                    </div>
                    <div style={{ background:req.status==="done"?`${C.green}22`:`${C.gold}22`, border:`1px solid ${req.status==="done"?C.green:C.gold}55`, borderRadius:20, padding:"3px 10px", fontSize:10, color:req.status==="done"?C.green:C.gold, fontFamily:"Arial, sans-serif" }}>
                      {req.status==="done"?"✅ DONE":"⏳ PENDING"}
                    </div>
                  </div>
                  {isCoach && req.status==="pending" && (
                    <button onClick={() => { setGroupRequests(prev => ({ ...prev, [group.id]: (prev[group.id]||[]).map((r,ri) => ri===reqs.length-1-i?{...r,status:"done"}:r) })); if (req._key && !req._key.startsWith("local_")) fbPatch(`group_requests/${group.id}/${req._key}`,{status:"done"}); }} style={{ ...S.btnCyan, marginTop:10, fontSize:12, padding:"8px", background:`linear-gradient(135deg,${C.green},#009944)`, color:C.white }}>✓ MARK COVERED</button>
                  )}
                </div>
              ))}
            </div>
          ...
          {groupView === "members" && (
            <div style={{ flex:1, padding:"14px 16px", overflowY:"auto" }}>
              <div style={{ ...S.card, padding:"16px", marginBottom:12, border:`1px solid ${group.color}44` }}>
                <div style={{ fontSize:18, letterSpacing:3, color:group.color }}>{group.name}</div>
                <div style={{ fontSize:12, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:4 }}>{group.type} · Created {group.createdAt}</div>
              </div>
              {isCoach && (
                <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${group.color},${group.color}88)`, color:"#000", marginBottom:16 }} onClick={() => {
                  // Add all roster students to this group
                  const updated = { ...group, members: roster.map(s => s.id) };
                  setCoachGroups(prev => prev.map(g => g.id===group.id ? updated : g));
                  setActiveGroup(updated);
                }}>+ ADD ALL ROSTER STUDENTS</button>
              )}
              <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:10 }}>COACH</div>
              <div style={{ ...S.card, padding:"12px 14px", marginBottom:12, border:`1px solid ${C.gold}44` }}>
              ...
              <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:10 }}>STUDENTS ({roster.filter(s => group.members?.includes(s.id)).length})</div>
              {roster.filter(s => group.members?.includes(s.id)).length === 0 && (
                <div style={{ fontFamily:"Arial, sans-serif", fontSize:13, color:C.gray, textAlign:"center", padding:"20px 0" }}>No students added yet — tap "Add All Roster Students" above.</div>
              )}
              {roster.filter(s => group.members?.includes(s.id)).map((s,i) => (
                <div key={i} style={{ ...S.card, padding:"12px 14px", marginBottom:8, display:"flex", alignItems:"center", gap:10 }}>
                  <div style={{ width:36, height:36, borderRadius:"50%", background:`linear-gradient(135deg,${group.color},${group.color}88)`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:16 }}>{s.avatar}</div>
                  <div style={{ flex:1 }}>
                    <div style={{ fontSize:14 }}>{s.name}</div>
                    <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>🥋 {s.belt} Belt</div>
                  </div>
                  {isCoach && <button onClick={() => { const updated = { ...group, members:(group.members||[]).filter(id=>id!==s.id) }; setCoachGroups(prev=>prev.map(g=>g.id===group.id?updated:g)); setActiveGroup(updated); }} style={{ background:"rgba(255,68,68,0.15)", border:"1px solid #FF4444", borderRadius:8, padding:"4px 10px", fontSize:11, color:"#FF4444", cursor:"pointer" }}>Remove</button>}
                </div>
              ))}
            </div>
          )}

          {/* ── PRACTICE PLANNER (per group) ── */}
          {groupView === "planner" && (
            <div style={{ flex:1, padding:"14px 16px", overflowY:"auto" }}>
              <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${group.color},${group.color}88)`, color:"#000", marginBottom:16 }} onClick={() => { setPracticePlan(null); setCoachingView("planner"); }}>
                📋 OPEN PRACTICE PLANNER
              </button>
              <div style={{ fontFamily:"Arial, sans-serif", fontSize:13, color:C.gray, lineHeight:1.7 }}>
                Build a full practice plan with warmup, technique, drilling, rolling timers, and cooldown — then assign it directly to <span style={{ color:group.color }}>{group.name}</span>.
              </div>
            </div>
          )}
          ...
          {/* Poll Modal */}
          {groupPollModal && (
            <div style={S.modal} onClick={() => setGroupPollModal(false)}>
              <div style={S.modalBox} onClick={e=>e.stopPropagation()}>
                <div style={{ fontSize:18, letterSpacing:3, color:group.color, marginBottom:14 }}>📊 CREATE POLL</div>
                <input style={S.input} placeholder="Poll question *" value={groupPollForm.question} onChange={e=>setGroupPollForm(p=>({...p,question:e.target.value}))} />
                {groupPollForm.options.map((opt,oi) => (
                  <div key={oi} style={{ display:"flex", gap:8, marginBottom:8 }}>
                    <input style={{ ...S.input, marginBottom:0, flex:1 }} placeholder={`Option ${oi+1}`} value={opt} onChange={e=>{ const opts=[...groupPollForm.options]; opts[oi]=e.target.value; setGroupPollForm(p=>({...p,options:opts})); }} />
                    {oi>=2 && <button onClick={() => setGroupPollForm(p=>({...p,options:p.options.filter((_,i)=>i!==oi)}))} style={{ background:"rgba(255,68,68,0.15)", border:"1px solid #FF4444", borderRadius:8, color:"#FF4444", fontSize:16, padding:"0 12px", cursor:"pointer" }}>✕</button>}
                  </div>
                ))}
                {groupPollForm.options.length < 4 && <button onClick={() => setGroupPollForm(p=>({...p,options:[...p.options,""]}))} style={{ ...S.btnCyan, marginBottom:12, fontSize:13 }}>+ Add Option</button>}
                <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${group.color},${group.color}88)`, color:"#000" }} onClick={submitGroupPoll}>CREATE POLL</button>
                <button style={S.btnCyan} onClick={() => setGroupPollModal(false)}>CANCEL</button>
              </div>
            </div>
          )}

          {/* Assign Drill Modal */}
          {groupAssignDrillModal && (
            <div style={S.modal} onClick={() => setGroupAssignDrillModal(false)}>
              <div style={{ ...S.modalBox, maxHeight:"75vh", overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
                <div style={{ fontSize:18, letterSpacing:3, color:group.color, marginBottom:14 }}>📋 ASSIGN DRILL</div>
                <input style={{ ...S.input, marginBottom:12 }} placeholder="Or type a custom drill name..." onChange={e => { if (e.target.value.trim()) { const d = { title:e.target.value.trim(), youtubeUrl:null, ts:Date.now(), time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}), done:false }; setGroupDrills(prev=>({...prev,[group.id]:[...(prev[group.id]||[]),{...d,_key:`local_${Date.now()}`}]})); fbPush(`group_drills/${group.id}`,d); setGroupAssignDrillModal(false); e.target.value=""; }}} />
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:10 }}>OR PICK FROM LIBRARY:</div>
                {Object.entries(videos.striking_drills?.offense||{}).map(([bucket,vids]) => vids.map((v,i) => (
                  <div key={`s_${i}`} onClick={async () => { const d={title:v.title,youtubeUrl:v.youtubeUrl||null,ts:Date.now(),time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),done:false}; setGroupDrills(prev=>({...prev,[group.id]:[...(prev[group.id]||[]),{...d,_key:`local_${Date.now()}`}]})); await fbPush(`group_drills/${group.id}`,d); setGroupAssignDrillModal(false); }} style={{ ...S.card, padding:"12px 14px", marginBottom:8, cursor:"pointer" }}>
                    <div style={{ fontSize:13 }}>{v.title}</div>
                    <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.pink, marginTop:2 }}>🥊 {bucket}</div>
                  </div>
                )))}
                {Object.values(videos.grappling_drills?.offense||{}).map((vids,bi) => vids.map((v,i) => (
                  <div key={`g_${bi}_${i}`} onClick={async () => { const d={title:v.title,youtubeUrl:v.youtubeUrl||null,ts:Date.now(),time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),done:false}; setGroupDrills(prev=>({...prev,[group.id]:[...(prev[group.id]||[]),{...d,_key:`local_${Date.now()}`}]})); await fbPush(`group_drills/${group.id}`,d); setGroupAssignDrillModal(false); }} style={{ ...S.card, padding:"12px 14px", marginBottom:8, cursor:"pointer" }}>
                    <div style={{ fontSize:13 }}>{v.title}</div>
                    <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.cyan, marginTop:2 }}>🤼 Grappling</div>
                  </div>
                )))}
                <button style={S.btnCyan} onClick={() => setGroupAssignDrillModal(false)}>CANCEL</button>
              </div>
            </div>
          )}
        </div>
    ...
    if (coachingView === "log") {
      return (
        <div style={{ ...S.app, overflowY:"auto" }}>
          <div style={{ ...S.header, borderBottomColor:C.gold }}>
            <button style={S.backBtn} onClick={() => setCoachingView("home")}>←</button>
            <div style={{ fontSize:16, letterSpacing:3, color:C.gold }}>📊 TEACHING LOG</div>
          </div>
          <div style={{ padding:"14px 16px" }}>
            {teachingLog.length === 0 && practiceLog.length === 0 && (
              <div style={{ textAlign:"center", padding:"40px 0", fontFamily:"Arial, sans-serif", color:C.gray }}>No practices logged yet. Build one in the Practice Planner!</div>
            )}
            {[...practiceLog].concat(teachingLog).sort((a,b) => new Date(b.savedAt||b.assignedAt||0) - new Date(a.savedAt||a.assignedAt||0)).map((log, i) => (
              <div key={i} style={{ ...S.card, padding:"14px", marginBottom:10 }}>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                  <div style={{ flex:1 }}>
                    <div style={{ fontSize:14, letterSpacing:1 }}>{log.title || "Practice Plan"}</div>
                    <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:3 }}>{log.savedAt || log.assignedAt} · {log.totalMins||60} min</div>
                    {log.blocks && <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.cyan, marginTop:4 }}>{log.blocks.map(b => b.label).join(" → ")}</div>}
                  </div>
                  <div style={{ background:log.done?`${C.green}22`:`${C.gold}22`, border:`1px solid ${log.done?C.green:C.gold}55`, borderRadius:20, padding:"3px 10px", fontSize:10, color:log.done?C.green:C.gold, fontFamily:"Arial, sans-serif" }}>
                    {log.done ? "✅ DONE" : "📋 SAVED"}
                  </div>
                </div>
                {!log.done && (
                  <button onClick={() => setTeachingLog(prev => prev.map((l,li) => li===i?{...l,done:true}:l))} style={{ ...S.btnCyan, marginTop:10, fontSize:12, padding:"8px", background:`linear-gradient(135deg,${C.green},#009944)`, color:C.white }}>✓ MARK AS TAUGHT</button>
                )}
              </div>
            ))}
          </div>
    ...
    // ── DM STUDENT VIEW ──
    if (coachingView === "dm" && dmStudent) {
      const msgs = dmMessages[dmStudent.id] || [];
      return (
        <div style={{ ...S.app, display:"flex", flexDirection:"column" }}>
          <div style={{ ...S.header, borderBottomColor:C.cyan }}>
            <button style={S.backBtn} onClick={() => setCoachingView("roster")}>←</button>
            <div style={{ flex:1 }}>
              <div style={{ fontSize:15, letterSpacing:2 }}>💬 {dmStudent.name}</div>
              <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>Direct Message</div>
            </div>
          </div>
          <div style={{ flex:1, padding:"12px 14px", overflowY:"auto" }}>
            {msgs.length === 0 && <div style={{ textAlign:"center", padding:"30px 0", fontFamily:"Arial, sans-serif", color:C.gray }}>No messages yet — start the conversation!</div>}
            {msgs.map((m,i) => (
              <div key={i} style={{ display:"flex", justifyContent: m.from==="coach" ? "flex-end" : "flex-start", marginBottom:10 }}>
                <div style={{ maxWidth:"75%", background: m.from==="coach" ? `${C.gold}22` : "rgba(255,255,255,0.06)", border:`1px solid ${m.from==="coach"?C.gold:C.border}`, borderRadius:14, padding:"10px 14px" }}>
                  <div style={{ fontFamily:"Arial, sans-serif", fontSize:13, color:C.white }}>{m.text}</div>
                  <div style={{ fontFamily:"Arial, sans-serif", fontSize:10, color:C.gray, marginTop:4, textAlign: m.from==="coach"?"right":"left" }}>{m.time}</div>
                </div>
              </div>
            ))}
          </div>
          <div style={{ padding:"10px 14px", borderTop:`1px solid ${C.border}`, display:"flex", gap:8 }}>
            <input style={{ ...S.input, marginBottom:0, flex:1, fontSize:14, padding:"12px 14px" }} placeholder={`Message ${dmStudent.name}...`} value={dmInput} onChange={e => setDmInput(e.target.value)} onKeyDown={e => e.key==="Enter" && dmInput.trim() && (setDmMessages(prev => ({ ...prev, [dmStudent.id]: [...(prev[dmStudent.id]||[]), { from:"coach", text:dmInput.trim(), time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}) }] })), setDmInput(""))} />
            <button style={{ background:C.gold, border:"none", borderRadius:10, padding:"0 16px", color:"#000", fontSize:18, cursor:"pointer" }} onClick={() => { if (dmInput.trim()) { setDmMessages(prev => ({ ...prev, [dmStudent.id]: [...(prev[dmStudent.id]||[]), { from:"coach", text:dmInput.trim(), time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}) }] })); setDmInput(""); } }}>↑</button>
          </div>
        </div>
      );
    }
    ...
    // ── FAVOURITES VIEW ──
    if (coachingView === "favourites") {
      return (
        <div style={{ ...S.app, overflowY:"auto" }}>
          <div style={{ ...S.header, borderBottomColor:C.pink }}>
            <button style={S.backBtn} onClick={() => setCoachingView("home")}>←</button>
            <div style={{ fontSize:16, letterSpacing:3, color:C.pink }}>❤️ FAVOURITES & PLAYLISTS</div>
          </div>
          <div style={{ padding:"14px 16px" }}>
            {/* Playlists */}
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:10 }}>
              <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2 }}>MY PLAYLISTS</div>
              <button onClick={() => setPlaylistModal(true)} style={{ background:`${C.pink}22`, border:`1px solid ${C.pink}44`, borderRadius:20, padding:"4px 12px", fontSize:11, color:C.pink, cursor:"pointer", fontFamily:"Arial, sans-serif" }}>+ NEW</button>
            </div>
            {playlists.length === 0 && <div style={{ fontFamily:"Arial, sans-serif", fontSize:13, color:C.gray, marginBottom:16, textAlign:"center", padding:"16px 0" }}>No playlists yet — create one!</div>}
            {playlists.map((pl,i) => (
              <div key={i} style={{ ...S.card, padding:"14px", marginBottom:10 }}>
                <div style={{ fontSize:14, letterSpacing:1 }}>🎬 {pl.name}</div>
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:3 }}>{pl.videos?.length || 0} videos</div>
              </div>
            ))}
            {/* Fav Videos */}
            <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:10, marginTop:16 }}>❤️ FAVOURITED VIDEOS</div>
            {favVideos.length === 0 && <div style={{ fontFamily:"Arial, sans-serif", fontSize:13, color:C.gray, textAlign:"center", padding:"16px 0" }}>No favourites yet — tap ❤️ on any video to save it here!</div>}
            {favVideos.map((v,i) => (
              <div key={i} style={{ ...S.card, padding:"14px", marginBottom:8, display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                <div style={{ flex:1 }}>
                  <div style={{ fontSize:13, letterSpacing:0.5 }}>{v.title}</div>
                  <div style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:2 }}>{v.discipline}</div>
                </div>
                <button onClick={() => setFavVideos(prev => prev.filter((_,fi) => fi !== i))} style={{ background:"rgba(255,68,68,0.15)", border:"1px solid #FF4444", borderRadius:8, padding:"4px 10px", color:"#FF4444", fontSize:12, cursor:"pointer" }}>✕</button>
              </div>
            ))}
          </div>
          <div style={{ height:90 }} />
          ...
          {playlistModal && (
            <div style={S.modal}>
              <div style={S.modalBox}>
                <div style={{ fontSize:18, letterSpacing:3, color:C.pink, marginBottom:14 }}>🎬 NEW PLAYLIST</div>
                <input style={S.input} placeholder="Playlist name *" value={newPlaylistName} onChange={e => setNewPlaylistName(e.target.value)} />
                <button style={{ ...S.btnPink, background:newPlaylistName.trim()?`linear-gradient(135deg,${C.pink},#C00090)`:"rgba(255,255,255,0.1)", color:newPlaylistName.trim()?C.white:C.gray }} onClick={() => { if (newPlaylistName.trim()) { setPlaylists(prev => [...prev, { name:newPlaylistName.trim(), videos:[] }]); setPlaylistModal(false); setNewPlaylistName(""); } }}>CREATE PLAYLIST</button>
                <button style={S.btnCyan} onClick={() => setPlaylistModal(false)}>CANCEL</button>
              </div>
            </div>
          )}
        </div>
            ...
            {roster.map(s => {
              ...
              return (
                <div key={s.id} onClick={() => { setSelectedStudent(s.id); setCoachingView("studentview"); }} style={{ ...S.card, padding: "14px 16px", display: "flex", gap: 14, alignItems: "center", cursor: "pointer", border: `1px solid ${C.gold}33` }}>
                  ...
                  <button onClick={e => { e.stopPropagation(); setDmStudent(s); setCoachingView("dm"); }} style={{ background:`${C.cyan}22`, border:`1px solid ${C.cyan}44`, borderRadius:8, padding:"6px 10px", fontSize:12, color:C.cyan, cursor:"pointer", flexShrink:0 }}>💬</button>
                </div>
              );
            })}
    ...
    if (coachingView === "team") {
      ...
      const sendTeamMsg = async (isPoll = false, pollData = null) => {
        ...
        // Update local state immediately for JSX preview
        setTeamMessages(prev => [...prev, { ...newMsg, _key: `local_${Date.now()}` }]);
      ...
      const voteTeamPoll = async (msgIdx, optIdx) => {
        ...
        // Also update Firebase if real key
        if (msg._key && !msg._key.startsWith("local_")) {
          const options = msg.options.map(opt => ({ ...opt, votes: { ...(opt.votes||{}) } }));
          options.forEach(opt => delete opt.votes[user.name]);
          if (!(msg.options[optIdx].votes||{})[user.name]) options[optIdx].votes[user.name] = true;
          fbPatch(`team_chats/${teamKey}/${msg._key}`, { options });
        }
      };
    ...
    return (
      <div style={S.app}>
          ...
          <>
            ...
            <div style={{ padding: "14px 16px 0" }}>
              ...
              {[
                ...
                { icon: "👥", label: "MY GROUPS", sub: coachGroups.length > 0 ? `${coachGroups.length} groups — BJJ, MMA & more` : "Create BJJ Class, MMA Team, etc.", color: "#9B5CFF", action: () => setCoachingView("groups") },
                { icon: "🔍", label: "FIND FIGHTERS", sub: "Search members to invite to your groups", color: C.pink, action: () => setUserSearchView(true) },
                { icon: "📋", label: "PRACTICE PLANNER", sub: "Build and assign 1-hour practice plans", color: C.gold, action: () => setCoachingView("planner") },
                { icon: "📊", label: "TEACHING LOG", sub: `${teachingLog.filter(l=>l.done).length} completed · ${teachingLog.filter(l=>!l.done).length} pending`, color: C.green, action: () => setCoachingView("log") },
                { icon: "❤️", label: "FAVOURITES & PLAYLISTS", sub: `${favVideos.length} saved videos · ${playlists.length} playlists`, color: C.pink, action: () => setCoachingView("favourites") },
                { icon: "👥", label: "MY ROSTER", sub: `${roster.length} students enrolled`, color: C.gold, action: () => setCoachingView("roster") },
                { icon: "✉️", label: "INVITE TO TEAM", sub: userTeam ? "Share your team invite link" : "Create a team first", color: C.pink, action: () => userTeam ? setShowGymPick(true) : setTeamCreateModal(true) },
        ...
        {teamJoinModal && (
          <div style={S.modal}>
            <div style={S.modalBox}>
              ...
              <div style={{ fontSize:12, fontFamily:"Arial, sans-serif", color:C.gray, marginBottom:16, lineHeight:1.7 }}>
                Enter your team code or the team name your coach gave you. Your request will be sent to the coach for approval.
              </div>
              <input style={S.input} placeholder="Team name or 6-digit code *" value={teamJoinName} onChange={e=>setTeamJoinName(e.target.value)} />
              <div style={{ background:`${C.gold}10`, border:`1px solid ${C.gold}33`, borderRadius:10, padding:"10px 12px", marginBottom:14, fontFamily:"Arial, sans-serif", fontSize:12, color:C.gray, lineHeight:1.6 }}>
                ⏳ Once submitted your coach will see your request and approve or decline it from the Coaching tab.
              </div>
              <button style={{ ...S.btnPink, background:teamJoinName.trim()?`linear-gradient(135deg,${C.cyan},#0099CC)`:"rgba(255,255,255,0.1)", color:teamJoinName.trim()?"#000":C.gray }} onClick={() => {
                ...
                const teamId = teamJoinName.trim().toLowerCase().replace(/\s/g,"_");
                setUserTeam({ id: teamId, name: teamJoinName.trim() });
        ...
        {/* Team Invite Modal */}
        {showGymPick && userTeam && (
          <div style={S.modal}>
            <div style={{ ...S.modalBox }}>
              <div style={{ fontSize:18, letterSpacing:3, color:C.cyan, marginBottom:6 }}>✉️ INVITE TO {userTeam.name}</div>
              <div style={{ fontSize:12, fontFamily:"Arial, sans-serif", color:C.gray, marginBottom:20, lineHeight:1.7 }}>
                Share your team invite link. When someone taps it they'll be prompted to download The MMA Manual and join your team automatically.
              </div>

              {/* Team code */}
              <div style={{ background:`${C.cyan}10`, border:`1px solid ${C.cyan}33`, borderRadius:12, padding:"14px", marginBottom:14, textAlign:"center" }}>
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:6 }}>YOUR TEAM CODE</div>
                <div style={{ fontSize:28, letterSpacing:6, color:C.cyan }}>{String(userTeam.id).slice(-6).toUpperCase()}</div>
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:4 }}>Students enter this code to join your team</div>
              </div>

              {/* Invite link */}
              <div style={{ background:"rgba(255,255,255,0.04)", border:`1px solid ${C.border}`, borderRadius:12, padding:"12px 14px", marginBottom:14 }}>
                <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, letterSpacing:2, marginBottom:6 }}>INVITE LINK</div>
                <div style={{ fontSize:12, fontFamily:"Arial, sans-serif", color:C.cyan, wordBreak:"break-all" }}>
                  themmamanual.com/join/{String(userTeam.id).slice(-6).toUpperCase()}
                </div>
              </div>

              {/* Share button */}
              <button style={{ ...S.btnPink, background:`linear-gradient(135deg,${C.cyan},#0099CC)`, color:"#000", marginBottom:10 }}
                onClick={() => {
                  const link = `themmamanual.com/join/${String(userTeam.id).slice(-6).toUpperCase()}`;
                  const msg = `Join my team "${userTeam.name}" on The MMA Manual! 🥋\n\nDownload the app and use my invite link:\nhttps://${link}\n\nOr enter team code: ${String(userTeam.id).slice(-6).toUpperCase()}`;
                  if (navigator.share) {
                    navigator.share({ title: "Join my MMA Manual team!", text: msg });
              ...
              <div style={{ background:`${C.gold}10`, border:`1px solid ${C.gold}33`, borderRadius:10, padding:"10px 12px", marginBottom:14, fontFamily:"Arial, sans-serif", fontSize:11, color:C.gray, lineHeight:1.6 }}>
                💡 When someone taps your link they'll be taken to download The MMA Manual, create an account, and automatically sent a join request to your team. You approve them in the Requests tab.
              </div>
  ...
  if (activeTab === "profile") {
    return (
      <div style={S.app}>
        ...
        <div style={{ background: `linear-gradient(135deg,rgba(255,20,147,0.12),rgba(0,207,255,0.08))`, border: `1px solid rgba(255,20,147,0.3)`, borderRadius: 16, margin: "20px", padding: "22px", display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:2, flexWrap:"wrap" }}>
              <div style={{ fontSize: 14, fontFamily: "Arial, sans-serif", color: C.cyan }}>{user.username}</div>
              {user.gymTag && <div style={{ background:`${C.gold}22`, border:`1px solid ${C.gold}55`, borderRadius:6, padding:"2px 8px", fontSize:11, fontFamily:"Arial, sans-serif", color:C.gold, fontWeight:"bold", letterSpacing:1 }}>{user.gymTag}</div>}
            </div>
            {user.gymName && <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray, marginTop:2 }}>🏛️ {user.gymName}</div>}
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"16px 20px", borderBottom:`1px solid ${C.border}`, fontFamily:"Arial, sans-serif" }}>
          <span style={{ fontSize:15, color:C.white }}>🎓 Coach Mode</span>
          <div onClick={async () => {
            const next = !isCoach;
            setIsCoach(next);
            if (authUid) await fbPatch(`users/${authUid}`, { isCoach: next });
            try { const s = JSON.parse(localStorage.getItem("mma_session")||"{}"); localStorage.setItem("mma_session", JSON.stringify({ ...s, user:{ ...(s.user||{}), isCoach: next } })); } catch(e) {}
          }} style={{ width:48, height:26, borderRadius:13, background:isCoach?C.gold:"rgba(255,255,255,0.15)", position:"relative", cursor:"pointer", transition:"background 0.2s" }}>
            <div style={{ width:22, height:22, borderRadius:"50%", background:C.white, position:"absolute", top:2, left:isCoach?24:2, transition:"left 0.2s" }} />
          </div>
        </div>
        <div style={{ padding:"6px 20px 10px", fontFamily:"Arial, sans-serif", fontSize:11, color:C.gray }}>{isCoach ? "🎓 You are in Coach Mode — access the full coaching toolkit" : "🥋 Switch to Coach Mode to create teams and assign drills"}</div>
        ...
        {[["⚙️","Settings"],["📹","My Uploads"],["❤️","Saved Moves"],["🔒","Privacy & Security"],["🚪","Sign Out"]].map(([icon,label],i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: `1px solid ${C.border}`, cursor: "pointer", fontFamily: "Arial, sans-serif", fontSize: 15, color: label === "Sign Out" ? C.pink : C.white }}
            onClick={() => {
              if (label === "Sign Out") {
                setUser(null); setAuthUid(null); setAuthToken(null); setIsCoach(false);
                try { localStorage.removeItem("mma_session"); } catch(e) {}
              }
              if (label === "❤️ Saved Moves" || label === "Saved Moves") setCoachingView("favourites");
            }}>
  ...
  if (userSearchView) {
    ...
    const filtered = q.length < 2 ? [] : members.filter(m =>
      (m.firstName||"").toLowerCase().includes(q) ||
      (m.lastName||"").toLowerCase().includes(q) ||
      (m.name||"").toLowerCase().includes(q) ||
      (m.username||"").toLowerCase().includes(q) ||
      (m.email||"").toLowerCase().includes(q) ||
      (m.gymTag||"").toLowerCase().includes(q) ||
      (m.gymName||"").toLowerCase().includes(q)
    );

    const sendFriendReq = (member) => {
      setSentRequests(prev => [...prev, { to: member.username, name: member.name, ts: Date.now() }]);
      fbPush(`friend_requests/${member.username?.replace("@","")}`, { from: user.username, fromName: user.name, ts: Date.now() });
    };

    const inviteToGroup = (member, group) => {
      setGroupInvites(prev => [...prev, { groupId: group.id, groupName: group.name, from: user.username }]);
      fbPush(`group_invites/${member.username?.replace("@","")}`, { groupId: group.id, groupName: group.name, from: user.username, fromName: user.name, ts: Date.now() });
    };

    return (
      <div style={{ ...S.app, display:"flex", flexDirection:"column" }}>
        <div style={S.header}>
          <button style={S.backBtn} onClick={() => { setUserSearchView(false); setUserSearchQ(""); }}>←</button>
          <div style={{ fontSize:16, letterSpacing:3 }}>🔍 FIND FIGHTERS</div>
        </div>
        ...
        <div style={{ padding:"12px 16px", borderBottom:`1px solid ${C.border}` }}>
          <div style={{ position:"relative" }}>
            <input
              style={{ ...S.input, marginBottom:0, paddingLeft:40, fontSize:15 }}
              placeholder="Name, @username, email or gym..."
              value={userSearchQ}
              onChange={e => setUserSearchQ(e.target.value)}
              autoFocus
            />
            <span style={{ position:"absolute", left:14, top:"50%", transform:"translateY(-50%)", fontSize:18 }}>🔍</span>
            {userSearchQ && <button onClick={() => setUserSearchQ("")} style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", color:C.gray, fontSize:18, cursor:"pointer" }}>✕</button>}
          </div>
        </div>
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"12px 16px" }}>
          {q.length < 2 && (
            <div style={{ textAlign:"center", padding:"40px 0", fontFamily:"Arial, sans-serif", color:C.gray }}>
              Search by name, @username, email, or gym tag 🥋
            </div>
          )}
          {q.length >= 2 && filtered.length === 0 && (
            <div style={{ textAlign:"center", padding:"40px 0", fontFamily:"Arial, sans-serif", color:C.gray }}>No fighters found for "{userSearchQ}"</div>
          )}
          {filtered.map((m, i) => {
            const alreadySent = sentRequests.some(r => r.to === m.username);
            const isFriend = friends.some(f => f.username === m.username);
            const isMe = m.email === user.email;
            return (
              <div key={i} style={{ ...S.card, padding:"14px", marginBottom:10 }}>
                <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                  {/* Avatar */}
                  <div style={{ width:50, height:50, borderRadius:"50%", background:`linear-gradient(135deg,${C.pink},${C.cyan})`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:20, flexShrink:0 }}>
                    {(m.firstName||m.name||"?")[0].toUpperCase()}
                  </div>
                  {/* Info */}
                  <div style={{ flex:1 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                      <div style={{ fontSize:15, letterSpacing:1 }}>{m.firstName && m.lastName ? `${m.firstName} ${m.lastName}` : m.name}</div>
                      {m.gymTag && <div style={{ background:`${C.gold}22`, border:`1px solid ${C.gold}44`, borderRadius:6, padding:"1px 7px", fontSize:10, color:C.gold, fontFamily:"Arial, sans-serif", fontWeight:"bold" }}>{m.gymTag}</div>}
                    </div>
                    <div style={{ fontSize:12, fontFamily:"Arial, sans-serif", color:C.cyan, marginTop:2 }}>{m.username}</div>
                    <div style={{ display:"flex", gap:6, marginTop:4, flexWrap:"wrap" }}>
                      {m.baseMart && <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.pink, background:`${C.pink}15`, borderRadius:10, padding:"2px 8px" }}>{m.baseMart}</span>}
                      {m.bjjBelt && m.bjjBelt !== "N/A" && <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gold, background:`${C.gold}15`, borderRadius:10, padding:"2px 8px" }}>🥋 {m.bjjBelt}</span>}
                      {m.gymName && <span style={{ fontSize:10, fontFamily:"Arial, sans-serif", color:C.gray }}>{m.gymName}</span>}
                    </div>
                  </div>
                  {/* Actions */}
                  {!isMe && (
                    <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
                      {isFriend ? (
                        <div style={{ background:`${C.green}22`, border:`1px solid ${C.green}44`, borderRadius:8, padding:"5px 10px", fontSize:11, color:C.green, fontFamily:"Arial, sans-serif" }}>✅ Friends</div>
                      ) : alreadySent ? (
                        <div style={{ background:"rgba(255,255,255,0.06)", border:`1px solid ${C.border}`, borderRadius:8, padding:"5px 10px", fontSize:11, color:C.gray, fontFamily:"Arial, sans-serif" }}>⏳ Sent</div>
                      ) : (
                        <button onClick={() => sendFriendReq(m)} style={{ background:`${C.cyan}22`, border:`1px solid ${C.cyan}44`, borderRadius:8, padding:"5px 10px", fontSize:11, color:C.cyan, cursor:"pointer", fontFamily:"Arial, sans-serif" }}>+ Add</button>
                      )}
                      {isCoach && coachGroups.length > 0 && (
                        <div style={{ position:"relative" }}>
                          <select onChange={e => { if (e.target.value) { const g = coachGroups.find(g=>g.id===e.target.value); if(g) inviteToGroup(m,g); e.target.value=""; } }} style={{ background:"rgba(255,255,255,0.06)", border:`1px solid ${C.border}`, borderRadius:8, padding:"5px 8px", fontSize:10, color:C.gray, cursor:"pointer", appearance:"none" }}>
                            <option value="">📋 Invite...</option>
                            {coachGroups.map(g => <option key={g.id} value={g.id}>{g.name}</option>)}
                          </select>
                        </div>
                      )}
                    </div>
                  )}
                  {isMe && <div style={{ fontSize:11, fontFamily:"Arial, sans-serif", color:C.gray }}>You</div>}
                </div>
              </div>
            );
          })}
  ...
  return (
    <div style={S.app}>
      ...
      {/* Member counter + MMA Hub shortcut + Find Fighters */}
      <div style={{ margin: "12px 20px 0", display: "flex", gap: 10 }}>
        <div style={{ background: `${C.cyan}10`, border: `1px solid ${C.cyan}22`, borderRadius: 14, padding: "12px 14px", textAlign: "center", minWidth: 80 }}>
          <div style={{ fontSize: 22, color: C.cyan, fontFamily: "Arial, sans-serif", fontWeight: "bold" }}>{memberCount.toLocaleString()}</div>
          <div style={{ fontSize: 9, fontFamily: "Arial, sans-serif", color: C.gray, letterSpacing: 1, marginTop: 2 }}>MEMBERS</div>
        </div>
        <div onClick={() => setActiveTab("community")} style={{ flex: 1, background: `linear-gradient(135deg,rgba(204,0,0,0.2),rgba(0,207,255,0.08))`, border: `1px solid rgba(204,0,0,0.35)`, borderRadius: 14, padding: "12px 16px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: 16, letterSpacing: 3, color: "#FF4444" }}>🏟️ THE MMA HUB</div>
            <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: "rgba(255,255,255,0.55)", marginTop: 3 }}>Talk MMA · Groups · Odds · Bets</div>
          </div>
          <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: "#FF4444", letterSpacing: 1 }}>ENTER →</div>
        </div>
      </div>

      {/* Find Fighters shortcut */}
      <div onClick={() => { setUserSearchView(true); setUserSearchQ(""); }} style={{ margin: "10px 20px 0", background: `${C.pink}08`, border: `1px solid ${C.pink}33`, borderRadius: 14, padding: "12px 16px", cursor: "pointer", display: "flex", alignItems: "center", gap: 12 }}>
        <span style={{ fontSize: 22 }}>🔍</span>
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 14, letterSpacing: 2, color: C.pink }}>FIND FIGHTERS</div>
          <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.gray, marginTop: 2 }}>Search members by name, @username or gym</div>
        </div>
        <div style={{ fontSize: 11, fontFamily: "Arial, sans-serif", color: C.pink }}>SEARCH →</div>
      </div>
      ...
      <div style={{ padding: "0 20px" }}>
        ...
        <div onClick={() => setSelCategory("fighters")} style={{ background: DISCIPLINES.fighters.gradient, border: `1px solid rgba(204,0,0,0.4)`, borderRadius: 16, padding: "22px", marginBottom: 14, cursor: "pointer", boxShadow: `0 4px 24px rgba(204,0,0,0.2)`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: 30, letterSpacing: 4 }}>BOXERS, UFC & BJJ FIGHTERS</div>
            <div style={{ fontSize: 12, fontFamily: "Arial, sans-serif", color: "rgba(255,255,255,0.6)", marginTop: 5 }}>UFC Fighters · Boxers · BJJ Fighters</div>
            <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
